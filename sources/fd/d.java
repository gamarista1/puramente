...
abstract class d {
    static int a(C4990b bVar) {
        return b(bVar, true) + b(bVar, false);
    }

    private static int b(C4990b bVar, boolean z10) {
        int i10;
        int i11;
        byte b10;
        if (z10) {
    ...
    static boolean f(int r1, int r2, int r3) {
        ...
        L_0x003d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: fd.d.f(int, int, int):boolean");
    }
