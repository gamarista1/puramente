...
public abstract class C6722a {
    private static final boolean a(String str) {
        int length = str.length();
        for (int i10 = 0; i10 < length; i10++) {
            char charAt = str.charAt(i10);
            if (C6496s.i(charAt, 31) <= 0 || C6496s.i(charAt, 127) >= 0 || p.a0(" #%/:?@[\\]", charAt, 0, false, 6, (Object) null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean b(String str, int i10, int i11, byte[] bArr, int i12) {
        ...
        while (i10 < i11) {
            ...
            while (i14 < i11) {
                ...
                if (C6496s.i(charAt, 48) < 0 || C6496s.i(charAt, 57) > 0) {
                    break;
    ...
    private static final java.net.InetAddress c(java.lang.String r18, int r19, int r20) {
        ...
        L_0x0015:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = Sg.p.I(r0, r1, r2, r3, r4, r5)
        ...
        L_0x00a8:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: sh.C6722a.c(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static final String d(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            if (i11 == i10) {
                ...
                eVar.e1((long) ((C6726e.d(bArr[i11], 255) << 8) | C6726e.d(bArr[i11 + 1], 255)));
                i11 += 2;
            }
        }
        return eVar.p1();
    ...
    public static final String e(String str) {
        ...
        C6496s.h(str, "<this>");
        if (p.O(str, Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR, false, 2, (Object) null)) {
            if (!p.J(str, "[", false, 2, (Object) null) || !p.u(str, "]", false, 2, (Object) null)) {
