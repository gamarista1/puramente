...
@Deprecated
public class XiaomiHomeBadger implements C6629a {

    /* renamed from: a  reason: collision with root package name */
    private ResolveInfo f72024a;

    private void c(Context context, int i10) {
        if (this.f72024a == null) {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.addCategory("android.intent.category.HOME");
            this.f72024a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f72024a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.f72024a.getIconResource()).build();
            try {
                ...
                throw new C6630b("not able to set badge", e10);
            }
        }
    }
    ...
    public void b(android.content.Context r5, android.content.ComponentName r6, int r7) {
        ...
        L_0x0061:
            ...
            r1.putExtra(r0, r6)
            qh.C6667a.c(r5, r1)     // Catch:{ b -> 0x006d }
        L_0x006d:
