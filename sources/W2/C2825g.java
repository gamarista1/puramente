...
public final class C2825g implements C2822d, x {

    /* renamed from: p  reason: collision with root package name */
    public static final C4770v f27725p = C4770v.P(4300000L, 3200000L, 2400000L, 1700000L, 860000L);

    /* renamed from: q  reason: collision with root package name */
    public static final C4770v f27726q = C4770v.P(1500000L, 980000L, 750000L, 520000L, 290000L);

    /* renamed from: r  reason: collision with root package name */
    public static final C4770v f27727r = C4770v.P(2000000L, 1300000L, 1000000L, 860000L, 610000L);

    /* renamed from: s  reason: collision with root package name */
    public static final C4770v f27728s = C4770v.P(2500000L, 1700000L, 1200000L, 970000L, 680000L);

    /* renamed from: t  reason: collision with root package name */
    public static final C4770v f27729t = C4770v.P(4700000L, 2800000L, 2100000L, 1700000L, 980000L);

    /* renamed from: u  reason: collision with root package name */
    public static final C4770v f27730u = C4770v.P(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);

    /* renamed from: v  reason: collision with root package name */
    private static C2825g f27731v;

    /* renamed from: a  reason: collision with root package name */
    private final C4771w f27732a;

    /* renamed from: b  reason: collision with root package name */
    private final C2822d.a.C0461a f27733b;

    /* renamed from: c  reason: collision with root package name */
    private final C2078c f27734c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f27735d;

    /* renamed from: e  reason: collision with root package name */
    private final C2831m f27736e;
    ...
    public static final class b {
        ...
        public b(Context context) {
            ...
            this.f27747a = context2;
            this.f27748b = b(L.O(context));
            this.f27749c = 2000;
            this.f27750d = C2078c.f22089a;
            this.f27751e = true;
        }

        private static Map b(String str) {
            int[] i10 = C2825g.j(str);
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            C4770v vVar = C2825g.f27725p;
            hashMap.put(2, (Long) vVar.get(i10[0]));
            hashMap.put(3, (Long) C2825g.f27726q.get(i10[1]));
            hashMap.put(4, (Long) C2825g.f27727r.get(i10[2]));
            hashMap.put(5, (Long) C2825g.f27728s.get(i10[3]));
            hashMap.put(10, (Long) C2825g.f27729t.get(i10[4]));
            hashMap.put(9, (Long) C2825g.f27730u.get(i10[5]));
            hashMap.put(7, (Long) vVar.get(i10[0]));
            return hashMap;
        }

        public C2825g a() {
            return new C2825g(this.f27747a, this.f27748b, this.f27749c, this.f27750d, this.f27751e);
        }
    }
    ...
    public static int[] j(java.lang.String r8) {
        ...
        L_0x10eb:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: w2.C2825g.j(java.lang.String):int[]");
    }

    private long k(int i10) {
        Long l10 = (Long) this.f27732a.get(Integer.valueOf(i10));
        if (l10 == null) {
            l10 = (Long) this.f27732a.get(0);
        }
        if (l10 == null) {
            l10 = 1000000L;
        }
    ...
    public static synchronized C2825g l(Context context) {
        C2825g gVar;
        synchronized (C2825g.class) {
            try {
                if (f27731v == null) {
                    f27731v = new b(context).a();
                }
                gVar = f27731v;
            } catch (Throwable th2) {
                while (true) {
    ...
    private static boolean m(j jVar, boolean z10) {
        if (!z10 || jVar.d(8)) {
            return false;
        }
        return true;
    ...
    private void n(int i10, long j10, long j11) {
        if (i10 != 0 || j10 != 0 || j11 != this.f27743l) {
            this.f27743l = j11;
            this.f27733b.c(i10, j10, j11);
        }
    }
    ...
    public synchronized void o(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f27744m     // Catch:{ all -> 0x000b }
            if (r0 == 0) goto L_0x000d
            boolean r1 = r8.f27735d     // Catch:{ all -> 0x000b }
        ...
        L_0x000b:
            ...
            goto L_0x0057
        L_0x000d:
            boolean r1 = r8.f27745n     // Catch:{ all -> 0x000b }
            if (r1 == 0) goto L_0x0013
            int r9 = r8.f27746o     // Catch:{ all -> 0x000b }
        L_0x0013:
            if (r0 != r9) goto L_0x0017
            monitor-exit(r8)
            return
        L_0x0017:
            r8.f27744m = r9     // Catch:{ all -> 0x000b }
            r0 = 1
        ...
        L_0x0023:
            ...
            r8.f27742k = r0     // Catch:{ all -> 0x000b }
            i2.c r9 = r8.f27734c     // Catch:{ all -> 0x000b }
            long r0 = r9.a()     // Catch:{ all -> 0x000b }
            int r9 = r8.f27737f     // Catch:{ all -> 0x000b }
            if (r9 <= 0) goto L_0x003a
            long r2 = r8.f27738g     // Catch:{ all -> 0x000b }
            long r2 = r0 - r2
        ...
        L_0x003a:
            ...
            goto L_0x0038
        L_0x003c:
            long r4 = r8.f27739h     // Catch:{ all -> 0x000b }
            long r6 = r8.f27742k     // Catch:{ all -> 0x000b }
            r2 = r8
            r2.n(r3, r4, r6)     // Catch:{ all -> 0x000b }
            r8.f27738g = r0     // Catch:{ all -> 0x000b }
            r0 = 0
            r8.f27739h = r0     // Catch:{ all -> 0x000b }
            r8.f27741j = r0     // Catch:{ all -> 0x000b }
            r8.f27740i = r0     // Catch:{ all -> 0x000b }
            w2.m r9 = r8.f27736e     // Catch:{ all -> 0x000b }
        ...
        L_0x0057:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: w2.C2825g.o(int):void");
    }

    public synchronized void b(f fVar, j jVar, boolean z10, int i10) {
        if (m(jVar, z10)) {
            this.f27739h += (long) i10;
        }
    }

    public void c(Handler handler, C2822d.a aVar) {
        C2076a.e(handler);
        C2076a.e(aVar);
        this.f27733b.b(handler, aVar);
    }

    public void d(C2822d.a aVar) {
        this.f27733b.e(aVar);
    }

    public synchronized void f(f fVar, j jVar, boolean z10) {
        try {
            if (m(jVar, z10)) {
                if (this.f27737f == 0) {
                    this.f27738g = this.f27734c.a();
                }
                this.f27737f++;
            }
        } catch (Throwable th2) {
    ...
    public synchronized void g(f fVar, j jVar, boolean z10) {
        boolean z11;
        try {
            if (m(jVar, z10)) {
                if (this.f27737f > 0) {
                ...
                C2076a.g(z11);
                long a10 = this.f27734c.a();
                int i10 = (int) (a10 - this.f27738g);
                this.f27740i += (long) i10;
                long j10 = this.f27741j;
                long j11 = this.f27739h;
                this.f27741j = j10 + j11;
                if (i10 > 0) {
                    this.f27736e.c((int) Math.sqrt((double) j11), (((float) j11) * 8000.0f) / ((float) i10));
                    if (this.f27740i < 2000) {
                        if (this.f27741j >= 524288) {
                        }
                        n(i10, this.f27739h, this.f27742k);
                        this.f27738g = a10;
                        this.f27739h = 0;
                    }
                    this.f27742k = (long) this.f27736e.f(0.5f);
                    n(i10, this.f27739h, this.f27742k);
                    this.f27738g = a10;
                    this.f27739h = 0;
                }
    ...
    private C2825g(Context context, Map map, int i10, C2078c cVar, boolean z10) {
        this.f27732a = C4771w.c(map);
        this.f27733b = new C2822d.a.C0461a();
        this.f27736e = new C2831m(i10);
        this.f27734c = cVar;
        this.f27735d = z10;
        if (context != null) {
            u d10 = u.d(context);
