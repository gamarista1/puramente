...
public abstract class u {
    ...
    private static final Pattern f23268a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f23269b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L_0x0028:
            ...
            java.util.regex.Pattern r0 = f23268a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto L_0x00a3
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch:{ NumberFormatException -> 0x008c }
            java.lang.Object r5 = i2.C2076a.e(r5)     // Catch:{ NumberFormatException -> 0x008c }
            ...
            java.lang.Object r0 = i2.C2076a.e(r0)     // Catch:{ NumberFormatException -> 0x008c }
        ...
        L_0x0064:
            ...
            i2.p.h(r2, r9)     // Catch:{ NumberFormatException -> 0x008c }
        ...
        L_0x00a3:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: k2.u.b(java.lang.String, java.lang.String):long");
    }
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f23269b.matcher(str);
        if (matcher.matches()) {
            return Long.parseLong((String) C2076a.e(matcher.group(1)));
        }
        return -1;
    }
}
