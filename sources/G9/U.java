...
final class U extends SQLiteOpenHelper {
    ...
    private static final String f43704c = ("INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")");

    /* renamed from: d  reason: collision with root package name */
    static int f43705d = 5;

    /* renamed from: e  reason: collision with root package name */
    private static final a f43706e;

    /* renamed from: f  reason: collision with root package name */
    private static final a f43707f;

    /* renamed from: g  reason: collision with root package name */
    private static final a f43708g;

    /* renamed from: h  reason: collision with root package name */
    private static final a f43709h;

    /* renamed from: i  reason: collision with root package name */
    private static final a f43710i;

    /* renamed from: j  reason: collision with root package name */
    private static final List f43711j;

    /* renamed from: a  reason: collision with root package name */
    private final int f43712a;

    /* renamed from: b  reason: collision with root package name */
    private boolean f43713b = false;
    ...
    static {
        ...
        T t10 = new T();
        f43710i = t10;
        f43711j = Arrays.asList(new a[]{o10, p10, q10, s10, t10});
    }
    ...
    public static /* synthetic */ void F(SQLiteDatabase sQLiteDatabase) {
        ...
        sQLiteDatabase.execSQL(f43704c);
    }
    ...
    private void M(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        ...
        if (i11 <= list.size()) {
            while (i10 < i11) {
                ((a) f43711j.get(i10)).a(sQLiteDatabase);
                i10++;
            }
            return;
        }
