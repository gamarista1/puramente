...
final class ComposableSingletons$TextInputPillKt$lambda4$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        ...
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            long r42 = SurveyViewModelKt.toSurveyUiColors(new SurveyCustomization((String) null, (String) null, 3, (DefaultConstructorMarker) null)).m423getButton0d7_KjU();
            long f10 = C2544x0.f25560b.f();
            h hVar = r3;
            h hVar2 = new h();
            TextInputPillKt.m517TextInputPillg5ZjG94("some text", "Enter text...", hVar, C2544x0.k(f10), r42, 0, false, (C6798l) null, 0, 0, false, (p) null, false, 0.0f, mVar, 3510, 6, 15328);
            mVar.u();
            return;
        }
        mVar.I();
