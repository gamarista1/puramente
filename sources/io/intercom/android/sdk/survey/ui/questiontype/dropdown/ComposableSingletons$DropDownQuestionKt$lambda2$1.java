...
final class ComposableSingletons$DropDownQuestionKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            DropDownQuestionKt.DropDownQuestion((i) null, DropDownQuestionKt.dropDownQuestionModel, (Answer) null, new a(), SurveyViewModelKt.toSurveyUiColors(new SurveyCustomization((String) null, (String) null, 3, (DefaultConstructorMarker) null)), (p) null, mVar, 3136, 37);
        } else {
            mVar.I();
        }
    }
