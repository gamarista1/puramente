...
public class LocationFormatter {
    ...
    public static CharSequence getLocationString(Context context, Location location, Date date) {
        ...
        Phrase put = Phrase.from(context, R.string.intercom_profile_location).put(a.f37179b, (CharSequence) simpleDateFormat.format(date));
        return put.put("location", (CharSequence) location.getCityName() + ", " + location.getCountryName()).format();
    }

    public static void postOnNextMinute(View view, Runnable runnable, TimeProvider timeProvider) {
        long currentTimeMillis = timeProvider.currentTimeMillis();
        long j10 = ONE_MINUTE_IN_MILLIS;
        view.postDelayed(runnable, j10 - (currentTimeMillis % j10));
    }
}
