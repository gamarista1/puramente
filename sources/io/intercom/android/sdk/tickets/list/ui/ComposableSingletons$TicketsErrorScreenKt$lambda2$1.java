...
final class ComposableSingletons$TicketsErrorScreenKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            TicketsErrorScreenKt.TicketsErrorScreen(new ErrorState.WithoutCTA(0, 0, (Integer) null, 7, (DefaultConstructorMarker) null), (i) null, mVar, 0, 2);
        } else {
            mVar.I();
        }
    }
