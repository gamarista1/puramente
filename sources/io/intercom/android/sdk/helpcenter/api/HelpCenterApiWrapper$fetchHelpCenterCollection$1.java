...
final class HelpCenterApiWrapper$fetchHelpCenterCollection$1 extends l implements p {
    ...
    static final class AnonymousClass1 extends l implements p {
        ...
        public final C6658d<C6514M> create(Object obj, C6658d<?> dVar) {
            return new AnonymousClass1(networkResponse, metricTracker, collectionContentRequestCallback, dVar);
        }
    ...
    HelpCenterApiWrapper$fetchHelpCenterCollection$1(MetricTracker metricTracker, String str, CollectionContentRequestCallback collectionContentRequestCallback, C6658d<? super HelpCenterApiWrapper$fetchHelpCenterCollection$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(K k10, C6658d<? super C6514M> dVar) {
        return ((HelpCenterApiWrapper$fetchHelpCenterCollection$1) create(k10, dVar)).invokeSuspend(C6514M.f71813a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            obj = HelpCenterApi.DefaultImpls.fetchCollectionDetails$default(helpCenterApi, str, (Map) null, this, 2, (Object) null);
            if (obj == f10) {
                return f10;
            }
        } else if (i10 == 1) {
