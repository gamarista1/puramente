...
final class ComposableSingletons$ReactionsComponentKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ReactionsComponentKt.ReactionsComponent((i) null, ArticleViewState.ReactionState.Companion.getDefaultReactionState(), new C6012l(), new m(), new n(), mVar, 28080, 1);
        } else {
            mVar.I();
        }
    }
