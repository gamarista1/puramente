...
final class ComposableSingletons$PreviewTopBarKt$lambda2$1 implements p {
    ...
    ComposableSingletons$PreviewTopBarKt$lambda2$1() {
    }
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            V.a(e.c(R.drawable.intercom_ic_delete, mVar, 0), "Delete", q.n(i.f23074a, h.j((float) 24)), 0, mVar, 440, 8);
        } else {
            mVar.I();
        }
    }
