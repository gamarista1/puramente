...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a#\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0003H\u0000¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lj3/v;", "Lj3/x;", "navController", "Landroidx/activity/j;", "rootActivity", "Llf/M;", "ticketsDestination", "(Lj3/v;Lj3/x;Landroidx/activity/j;)V", "intercom-sdk-base_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
public final class TicketsDestinationKt {
    public static final void ticketsDestination(v vVar, x xVar, C1554j jVar) {
        C6496s.h(vVar, "<this>");
        C6496s.h(xVar, "navController");
        C6496s.h(jVar, "rootActivity");
        C2159k.b(vVar, "TICKETS?transitionArgs={transitionArgs}&isLaunchedProgrammatically={isLaunchedProgrammatically}", C6565s.q(C2135f.a("transitionArgs", new T0()), C2135f.a("isLaunchedProgrammatically", new U0())), (List) null, new V0(), new W0(), new X0(), new Y0(), (C6798l) null, c.c(655582181, true, new TicketsDestinationKt$ticketsDestination$7(jVar, xVar)), 132, (Object) null);
    }

    /* access modifiers changed from: private */
    public static final C6514M ticketsDestination$lambda$0(i iVar) {
    ...
    /* access modifiers changed from: private */
    public static final C6514M ticketsDestination$lambda$1(i iVar) {
        C6496s.h(iVar, "$this$navArgument");
    ...
    /* access modifiers changed from: private */
    public static final androidx.compose.animation.i ticketsDestination$lambda$2(d dVar) {
    ...
    /* access modifiers changed from: private */
    public static final androidx.compose.animation.k ticketsDestination$lambda$3(d dVar) {
        C6496s.h(dVar, "$this$composable");
    ...
    /* access modifiers changed from: private */
    public static final androidx.compose.animation.i ticketsDestination$lambda$4(d dVar) {
        C6496s.h(dVar, "$this$composable");
    ...
    /* access modifiers changed from: private */
    public static final androidx.compose.animation.k ticketsDestination$lambda$5(d dVar) {
        C6496s.h(dVar, "$this$composable");
