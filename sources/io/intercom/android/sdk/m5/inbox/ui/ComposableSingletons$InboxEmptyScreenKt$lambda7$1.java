...
final class ComposableSingletons$InboxEmptyScreenKt$lambda7$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            InboxEmptyScreenKt.InboxEmptyScreen(new EmptyState("No messages", "Messages from the team, queries and support tickets will be visible here", new EmptyState.Action(ActionType.MESSAGE, "Ask a question", IconType.BOT)), true, new d(), (i) null, mVar, 432, 8);
        } else {
            mVar.I();
        }
    }
