...
final class ComposableSingletons$HomeErrorContentKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeErrorContentKt.HomeErrorContent(new ErrorState.WithCTA(0, 0, (Integer) null, 0, new a(), 15, (DefaultConstructorMarker) null), (i) null, mVar, 0, 2);
        } else {
            mVar.I();
        }
    }
