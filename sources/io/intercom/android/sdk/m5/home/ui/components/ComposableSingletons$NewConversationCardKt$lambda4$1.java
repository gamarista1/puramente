...
final class ComposableSingletons$NewConversationCardKt$lambda4$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeCards.HomeNewConversationData homeNewConversationData = new HomeCards.HomeNewConversationData("Get in touch", HomeCardType.NEW_CONVERSATION, new Action("Ask a question", IconType.FIN, (String) null), false, C6565s.n(), true, true, (OpenMessengerResponse.NewConversationData.HomeCard) null);
            ...
            NewConversationCardKt.NewConversationCard(homeNewConversationData, q10, new AvatarWrapper(create5, false, 2, (DefaultConstructorMarker) null), new d(), mVar, 3656, 0);
            return;
        }
        mVar.I();
    }
