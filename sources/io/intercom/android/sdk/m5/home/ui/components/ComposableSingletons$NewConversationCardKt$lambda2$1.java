...
final class ComposableSingletons$NewConversationCardKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeCards.HomeNewConversationData homeNewConversationData = new HomeCards.HomeNewConversationData("Get in touch", HomeCardType.NEW_CONVERSATION, new Action("Ask a question", IconType.BOT, "Usual reply time is a few minutes"), false, C6565s.n(), false, false, (OpenMessengerResponse.NewConversationData.HomeCard) null);
            ...
            NewConversationCardKt.NewConversationCard(homeNewConversationData, C6565s.q(avatarWrapper, avatarWrapper2, avatarWrapper3, new AvatarWrapper(create4, false, 2, (DefaultConstructorMarker) null)), (AvatarWrapper) null, new b(), mVar, 3144, 4);
            return;
        }
        mVar.I();
    }
