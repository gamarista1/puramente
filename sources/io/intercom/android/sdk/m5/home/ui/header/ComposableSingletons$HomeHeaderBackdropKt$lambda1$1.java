...
final class ComposableSingletons$HomeHeaderBackdropKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeHeaderBackdropKt.m390HomeHeaderBackdroporJrPs(h.j((float) 200), new HomeUiState.Content.ContentHeader.HeaderBackdropStyle.Solid(C2550z0.b(ColorUtils.parseColor("#326D7D")), false, (DefaultConstructorMarker) null), new a(), mVar, 390);
        } else {
            mVar.I();
        }
    }
