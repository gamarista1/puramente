...
final class ComposableSingletons$LegacyMessengerAppCardKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            IntercomThemeKt.IntercomTheme((IntercomColors) null, (IntercomTypography) null, (B0) null, ComposableSingletons$LegacyMessengerAppCardKt.INSTANCE.m373getLambda1$intercom_sdk_base_release(), mVar, 3072, 7);
        } else {
            mVar.I();
        }
    }
