...
final class ComposableSingletons$HomeHeaderBackdropKt$lambda4$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            HomeHeaderBackdropKt.m390HomeHeaderBackdroporJrPs(j10, new HomeUiState.Content.ContentHeader.HeaderBackdropStyle.Gradient(arrayList, true), new d(), mVar, 454);
            return;
        }
        mVar.I();
    }
