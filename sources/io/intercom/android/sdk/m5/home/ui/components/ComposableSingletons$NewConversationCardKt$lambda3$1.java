...
final class ComposableSingletons$NewConversationCardKt$lambda3$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeCards.HomeNewConversationData homeNewConversationData = new HomeCards.HomeNewConversationData("Get in touch", HomeCardType.NEW_CONVERSATION, new Action("Ask a question", IconType.FACE_PILE, "Team can help if needed"), false, C6565s.n(), true, true, (OpenMessengerResponse.NewConversationData.HomeCard) null);
            ...
            List q10 = C6565s.q(avatarWrapper, avatarWrapper2, avatarWrapper3, new AvatarWrapper(create4, false, 2, (DefaultConstructorMarker) null));
            Avatar create5 = Avatar.create("", "B");
            C6496s.g(create5, "create(...)");
            NewConversationCardKt.NewConversationCard(homeNewConversationData, q10, new AvatarWrapper(create5, false, 2, (DefaultConstructorMarker) null), new c(), mVar, 3656, 0);
            return;
        }
        mVar.I();
    }
