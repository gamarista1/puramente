...
final class ComposableSingletons$ConversationEndedCardKt$lambda4$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ConversationEndedCardKt.ConversationEndedCard((i) null, new C6041o(), new ComposerState.ConversationEnded(new StringProvider.ActualString("You have another conversation about this issue"), new ComposerState.ConversationEnded.ConversationEndedCta(new StringProvider.ActualString("Continue the conversation"), R.drawable.intercom_send_message_icon, "123")), mVar, (StringProvider.$stable << 6) | 48, 1);
            return;
        }
        mVar.I();
    }
