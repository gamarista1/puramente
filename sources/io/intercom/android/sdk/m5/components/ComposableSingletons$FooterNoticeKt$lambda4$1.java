...
final class ComposableSingletons$FooterNoticeKt$lambda4$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            FooterNoticeKt.FooterNoticePillWithoutAnimation("The team will reply in 1314 minutes", C6565s.e(new AvatarWrapper(create, false, 2, (DefaultConstructorMarker) null)), new C6058x(), mVar, 454);
            return;
        }
        mVar.I();
    }
