...
final class ComposableSingletons$ConversationItemKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            Ticket.Status status = r16;
            Ticket.Status status2 = new Ticket.Status("Resolved", "resolved", (String) null, false, 0, 28, (DefaultConstructorMarker) null);
            float f10 = (float) 16;
            ConversationItemKt.ConversationItem(ConversationItemKt.sampleConversation$default(new Ticket((String) null, (String) null, "Feature request", (String) null, (String) null, (String) null, status, (List) null, (List) null, 0, (Participant.Builder) null, (String) null, (Ticket.ConversationButton) null, (Boolean) null, 0, 32699, (DefaultConstructorMarker) null), false, 2, (Object) null), d10, n.b(h.j(f10), h.j(f10)), false, new C6048s(), mVar, 24584, 8);
            return;
        }
        mVar.I();
    }
