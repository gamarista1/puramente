...
final class ComposableSingletons$EmptyStateKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            IntercomPrimaryButtonKt.IntercomPrimaryButton("Send us a message", (i) null, Integer.valueOf(R.drawable.intercom_send), new C6054v(), mVar, 3078, 2);
        } else {
            mVar.I();
        }
    }
