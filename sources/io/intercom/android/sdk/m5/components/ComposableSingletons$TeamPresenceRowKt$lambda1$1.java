...
final class ComposableSingletons$TeamPresenceRowKt$lambda1$1 implements p {
    ...
    ComposableSingletons$TeamPresenceRowKt$lambda1$1() {
    }
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            TeamPresenceRowKt.TeamPresenceRow((i) null, C6565s.q(avatarWrapper, avatarWrapper2, avatarWrapper3, new AvatarWrapper(create4, false, 2, (DefaultConstructorMarker) null)), mVar, 64, 1);
            return;
        }
        mVar.I();
    }
