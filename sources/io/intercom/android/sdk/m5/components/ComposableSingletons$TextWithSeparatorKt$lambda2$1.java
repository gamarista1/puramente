...
final class ComposableSingletons$TextWithSeparatorKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            TextWithSeparatorKt.m206TextWithSeparatorwV1YYcM("", "Yesterday", (i) null, (String) null, (T) null, 0, 0, 0, (j) null, mVar, 54, 508);
        } else {
            mVar.I();
        }
    }
