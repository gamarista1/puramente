...
final class ComposableSingletons$PoweredByBadgeKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            PoweredByBadgeKt.m205PoweredByBadgewBJOh4Y("Powered by Intercom", PoweredBy.PoweredByIconType.INTERCOM, new C(), (i) null, 0, 0, mVar, 438, 56);
        } else {
            mVar.I();
        }
    }
