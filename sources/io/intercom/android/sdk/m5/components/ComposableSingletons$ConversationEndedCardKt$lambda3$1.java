...
final class ComposableSingletons$ConversationEndedCardKt$lambda3$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ConversationEndedCardKt.ConversationEndedCard((i) null, new C6039n(), new ComposerState.ConversationEnded(new StringProvider.StringRes(R.string.intercom_conversation_has_ended, (List) null, 2, (DefaultConstructorMarker) null), new ComposerState.ConversationEnded.ConversationEndedCta(new StringProvider.ActualString("Ask a question"), R.drawable.intercom_conversation_card_question, (String) null, 4, (DefaultConstructorMarker) null)), mVar, (StringProvider.$stable << 6) | 48, 1);
            return;
        }
        mVar.I();
    }
