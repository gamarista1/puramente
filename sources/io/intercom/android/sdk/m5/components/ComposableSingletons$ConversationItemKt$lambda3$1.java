...
final class ComposableSingletons$ConversationItemKt$lambda3$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            float f10 = (float) 16;
            ConversationItemKt.ConversationItem(ConversationItemKt.sampleConversation$default((Ticket) null, false, 3, (Object) null), d10, n.b(h.j(f10), h.j(f10)), false, new C6050t(), mVar, 24584, 8);
            return;
        }
        mVar.I();
    }
