...
final class ComposableSingletons$SearchBrowseCardKt$lambda3$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            HomeCards.HomeHelpCenterData homeHelpCenterData = new HomeCards.HomeHelpCenterData("Help Center", HomeCardType.HELP_CENTER, C6565s.q(new SuggestedArticle("", "How to restart recording", ""), new SuggestedArticle("", "How to track your recording time", ""), new SuggestedArticle("", "How to correct your transcript", "")));
            ...
            SearchBrowseCardKt.SearchBrowseCard(homeHelpCenterData, false, q10, true, metricTracker, mVar, 36408);
            return;
        }
        mVar.I();
    }
