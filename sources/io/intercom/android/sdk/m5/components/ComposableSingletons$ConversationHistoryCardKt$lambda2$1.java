...
final class ComposableSingletons$ConversationHistoryCardKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            ConversationHistoryCardKt.ConversationHistoryCard(h10, "Your recent conversations", C6565s.a(c10), new C6045q(), mVar, 3638, 0);
            return;
        }
        mVar.I();
    }
