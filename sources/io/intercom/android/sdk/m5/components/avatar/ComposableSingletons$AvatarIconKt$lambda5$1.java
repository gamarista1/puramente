...
final class ComposableSingletons$AvatarIconKt$lambda5$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        ...
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            float f10 = (float) 36;
            C1500m mVar3 = mVar;
            AvatarIconKt.m208AvatarIconRd90Nhg(q.n(aVar, c1.h.j(f10)), new AvatarWrapper(create, true), (g2) null, false, 0, (C2544x0) null, mVar3, 70, 60);
            a0.a(q.r(aVar, c1.h.j((float) 16)), mVar2, 6);
            Avatar create2 = Avatar.create("", "");
            C6496s.g(create2, "create(...)");
            AvatarIconKt.m208AvatarIconRd90Nhg(q.n(aVar, c1.h.j(f10)), new AvatarWrapper(create2, true), (g2) null, false, 0, (C2544x0) null, mVar3, 70, 60);
            mVar.u();
            return;
        }
        mVar.I();
