...
final class ComposableSingletons$AvatarIconKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        ...
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            float f11 = f10;
            C1500m mVar3 = mVar;
            AvatarIconKt.m208AvatarIconRd90Nhg(q.n(aVar, c1.h.j(f10)), new AvatarWrapper(create, false, 2, (DefaultConstructorMarker) null), (g2) null, true, 0, (C2544x0) null, mVar3, 3142, 52);
            a0.a(q.r(aVar, c1.h.j((float) 16)), mVar2, 6);
            Avatar create2 = Avatar.create("", "");
            C6496s.g(create2, "create(...)");
            AvatarIconKt.m208AvatarIconRd90Nhg(q.n(aVar, c1.h.j(f11)), new AvatarWrapper(create2, false, 2, (DefaultConstructorMarker) null), (g2) null, true, 0, (C2544x0) null, mVar3, 3142, 52);
            mVar.u();
            return;
        }
        mVar.I();
