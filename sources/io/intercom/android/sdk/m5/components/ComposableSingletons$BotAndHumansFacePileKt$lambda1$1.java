...
final class ComposableSingletons$BotAndHumansFacePileKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            BotAndHumansFacePileKt.m138BotAndHumansFacePilehGBTI10((i) null, create, new Pair(Avatar.create("", "SK"), Avatar.create("", "RS")), h.j((float) 64), "Fin", mVar, 28224, 1);
            return;
        }
        mVar.I();
    }
