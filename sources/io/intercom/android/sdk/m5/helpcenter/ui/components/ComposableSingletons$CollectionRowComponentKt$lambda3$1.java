...
final class ComposableSingletons$CollectionRowComponentKt$lambda3$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            CollectionRowComponentKt.CollectionRowComponent(new CollectionRowData("", "Lorem Ipsum Dolor Sit", 0, "", 3, 2), new z(), (i) null, mVar, 48, 4);
        } else {
            mVar.I();
        }
    }
