...
final class ComposableSingletons$FinAnswerRowKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            Part build = new Part.Builder().withParticipantIsAdmin(true).withBlocks(C6565s.q(BubbleMessageRowKt.getAnswerBlock(), BubbleMessageRowKt.getLongParagraphBlock())).withMetadata(new io.intercom.android.sdk.models.Metadata("Bot", "AI Agent", Long.valueOf(System.currentTimeMillis()), C6565s.e(new Avatar.Builder().withInitials("BB").withShape(AvatarShape.SQUIRCLE)))).withSources(C6565s.q(new Source("", "other", "Changing the date of your stay using our mobile app", ""), new Source("", "article", "Cancel your booking", ""))).build();
            C6496s.g(build, "build(...)");
            FinAnswerRowKt.FinAnswerRow(build, GroupingPosition.STANDALONE, (i) null, (String) null, mVar, 56, 12);
            a0.a(q.i(aVar, c1.h.j(f10)), mVar, 6);
            mVar.u();
            return;
        }
