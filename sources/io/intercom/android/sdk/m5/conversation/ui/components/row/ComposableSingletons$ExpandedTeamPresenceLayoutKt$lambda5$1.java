...
final class ComposableSingletons$ExpandedTeamPresenceLayoutKt$lambda5$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            ExpandedTeamPresenceLayoutKt.ExpandedTeamPresenceLayout(new ExpandedTeamPresenceState("SDKTestApp", q10, avatarType, C6565s.e(new AvatarWrapper(create, false, 2, (DefaultConstructorMarker) null)), C6565s.n(), C6565s.n(), true), (i) null, mVar, 8, 2);
            return;
        }
        mVar.I();
    }
