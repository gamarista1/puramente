...
final class HeaderMenuItemRowKt$UnreadBadge$1 implements q {
    final /* synthetic */ String $badgeText;
    final /* synthetic */ long $contentColor;

    HeaderMenuItemRowKt$UnreadBadge$1(long j10, String str) {
    ...
    public final void invoke(Y y10, C1500m mVar, int i10) {
        ...
        if ((i10 & 81) != 16 || !mVar.i()) {
            i.a aVar = i.f23074a;
            T type05 = IntercomTheme.INSTANCE.getTypography(mVar, IntercomTheme.$stable).getType05();
            int a10 = j.f19110b.a();
