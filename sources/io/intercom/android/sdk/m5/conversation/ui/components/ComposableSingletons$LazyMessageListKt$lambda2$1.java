...
final class ComposableSingletons$LazyMessageListKt$lambda2$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            ...
            Part build3 = new Part.Builder().withParticipantIsAdmin(true).withBlocks(C6565s.e(BubbleMessageRowKt.getArticleBlock())).build();
            ...
            Part build4 = new Part.Builder().withParticipantIsAdmin(true).withBlocks(C6565s.e(BubbleMessageRowKt.getCreateTicketBlock())).build();
            ...
            C6112f fVar = r0;
            C6112f fVar2 = new C6112f();
            LazyMessageListKt.LazyMessageList((i) null, a10, (A) null, (C6798l) null, fVar, (C6798l) null, (C6798l) null, (C6798l) null, (C6787a) null, (C6798l) null, false, (C6798l) null, false, mVar, 24640, 0, 8173);
            return;
        }
        mVar.I();
    }
