...
final class ComposableSingletons$NoteCardRowKt$lambda1$1 implements p {
    ...
    public final void invoke(C1500m mVar, int i10) {
        if ((i10 & 11) != 2 || !mVar.i()) {
            Part build = new Part.Builder().withParticipantIsAdmin(false).withBlocks(C6565s.q(BubbleMessageRowKt.getParagraphBlock(), BubbleMessageRowKt.getLongParagraphBlock(), BubbleMessageRowKt.getLongParagraphBlock())).build();
            build.setParticipant(Participant.create("", "Paul", Participant.USER_TYPE, "", Avatar.create("", "PK"), Boolean.FALSE));
            C6496s.g(build, "apply(...)");
            NoteCardRowKt.NoteCardRow((i) null, build, "SDK Test App", mVar, 448, 1);
            return;
        }
        mVar.I();
    }
