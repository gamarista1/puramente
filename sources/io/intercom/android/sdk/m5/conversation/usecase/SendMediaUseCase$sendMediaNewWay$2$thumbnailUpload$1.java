...
@f(c = "io.intercom.android.sdk.m5.conversation.usecase.SendMediaUseCase$sendMediaNewWay$2$thumbnailUpload$1", f = "SendMediaUseCase.kt", l = {264}, m = "invokeSuspend")
final class SendMediaUseCase$sendMediaNewWay$2$thumbnailUpload$1 extends l implements p {
    final /* synthetic */ MediaData.Media $compressedMediaData;
    int label;
    final /* synthetic */ SendMediaUseCase this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SendMediaUseCase$sendMediaNewWay$2$thumbnailUpload$1(SendMediaUseCase sendMediaUseCase, MediaData.Media media, C6658d<? super SendMediaUseCase$sendMediaNewWay$2$thumbnailUpload$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(K k10, C6658d<? super NetworkResponse<Upload.Builder>> dVar) {
        return ((SendMediaUseCase$sendMediaNewWay$2$thumbnailUpload$1) create(k10, dVar)).invokeSuspend(C6514M.f71813a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            obj = access$getConversationRepository$p.uploadMedia(thumbnail, this);
            if (obj == f10) {
                return f10;
            }
        } else if (i10 == 1) {
