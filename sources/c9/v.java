...
public abstract class v {
    ...
    private static final Pattern f30256a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap f30257b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private static int f30258c = -1;
    ...
    private static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (TextUtils.equals(this.f30259a, bVar.f30259a) && this.f30260b == bVar.f30260b && this.f30261c == bVar.f30261c) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            int i10;
            int hashCode = (this.f30259a.hashCode() + 31) * 31;
            int i11 = 1237;
            if (this.f30260b) {
                i10 = 1231;
            } else {
    ...
    private static final class f implements d {
        ...
        /* renamed from: b  reason: collision with root package name */
        private MediaCodecInfo[] f30263b;
        ...
        private void f() {
            if (this.f30263b == null) {
                this.f30263b = new MediaCodecList(this.f30262a).getCodecInfos();
            }
        }
    ...
    private static boolean A(MediaCodecInfo mediaCodecInfo) {
        if (M.f44981a < 29 || !B(mediaCodecInfo)) {
            return false;
        }
        return true;
    }
    ...
    private static boolean C(MediaCodecInfo mediaCodecInfo, String str, boolean z10, String str2) {
        ...
        if (i10 < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(M.f44983c) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = M.f44982b;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = M.f44982b;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i10 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && Constants.REFERRER_API_SAMSUNG.equals(M.f44983c))) {
            String str6 = M.f44982b;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i10 <= 19 && "OMX.SEC.vp8.dec".equals(str) && Constants.REFERRER_API_SAMSUNG.equals(M.f44983c)) {
            String str7 = M.f44982b;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i10 <= 19 && M.f44982b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    public static /* synthetic */ int J(n nVar) {
        ...
        if (M.f44981a >= 26 || !str.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
            return 0;
        }
        return -1;
    }
    ...
    public static /* synthetic */ int K(n nVar) {
        return nVar.f30166a.startsWith("OMX.google") ? 1 : 0;
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ int L(C3717q0 q0Var, n nVar) {
        try {
            return nVar.m(q0Var) ? 1 : 0;
        } catch (c unused) {
            return -1;
        }
    }
    ...
    private static void P(List list, g gVar) {
    ...
    private static void e(String str, List list) {
        if ("audio/raw".equals(str)) {
            if (M.f44981a < 26 && M.f44982b.equals("R9") && list.size() == 1 && ((n) list.get(0)).f30166a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                list.add(n.C("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false, false));
            }
            P(list, new r());
        }
        int i10 = M.f44981a;
        if (i10 < 21 && list.size() > 1) {
            String str2 = ((n) list.get(0)).f30166a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                P(list, new s());
            }
        }
        if (i10 < 32 && list.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((n) list.get(0)).f30166a)) {
    ...
    private static Pair l(String str, String[] strArr) {
        int O10;
        if (strArr.length != 3) {
            s.i("MediaCodecUtil", "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
            if ("audio/mp4a-latm".equals(w.h(Integer.parseInt(strArr[1], 16))) && (O10 = O(Integer.parseInt(strArr[2]))) != -1) {
                return new Pair(Integer.valueOf(O10), 0);
            }
    ...
    public static String m(C3717q0 q0Var) {
        Pair q10;
        if ("audio/eac3-joc".equals(q0Var.f45770l)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(q0Var.f45770l) || (q10 = q(q0Var)) == null) {
            return null;
        }
    ...
    private static Pair n(String str, String[] strArr, ka.c cVar) {
        int i10;
        if (strArr.length < 4) {
            s.i("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i11 = 1;
        try {
            ...
            if (parseInt != 0) {
                s.i("MediaCodecUtil", "Unknown AV1 profile: " + parseInt);
                return null;
            } else if (parseInt3 == 8 || parseInt3 == 10) {
                if (parseInt3 != 8) {
                    if (cVar == null || !(cVar.f45960d != null || (i10 = cVar.f45959c) == 7 || i10 == 6)) {
                        i11 = 2;
                    } else {
                        i11 = 4096;
                    }
                ...
                s.i("MediaCodecUtil", "Unknown AV1 level: " + parseInt2);
                return null;
            } else {
                s.i("MediaCodecUtil", "Unknown AV1 bit depth: " + parseInt3);
                return null;
            }
        } catch (NumberFormatException unused) {
            s.i("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
    ...
    private static Pair o(String str, String[] strArr) {
        ...
        int i11;
        if (strArr.length < 2) {
            s.i("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            int i12 = i(i11);
            if (i12 == -1) {
                s.i("MediaCodecUtil", "Unknown AVC profile: " + i11);
                return null;
            }
            int g10 = g(i10);
            if (g10 != -1) {
            ...
            s.i("MediaCodecUtil", "Unknown AVC level: " + i10);
            return null;
        } catch (NumberFormatException unused) {
            s.i("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
    ...
    public static android.util.Pair q(k9.C3717q0 r6) {
        /*
            r0 = 0
            java.lang.String r1 = r6.f45767i
            r2 = 0
        ...
        L_0x0007:
            ...
            java.lang.String r4 = r6.f45770l
            boolean r3 = r3.equals(r4)
            if (r3 == 0) goto L_0x001e
            java.lang.String r6 = r6.f45767i
        ...
        L_0x0091:
            ...
            return r6
        L_0x0098:
            java.lang.String r0 = r6.f45767i
            ka.c r6 = r6.f45782x
            android.util.Pair r6 = n(r0, r1, r6)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: C9.v.q(k9.q0):android.util.Pair");
    }
    ...
    public static synchronized List s(String str, boolean z10, boolean z11) {
        ...
        synchronized (v.class) {
            try {
                ...
                ArrayList t10 = t(bVar, dVar);
                if (z10 && t10.isEmpty() && 21 <= i10 && i10 <= 23) {
                    t10 = t(bVar, new e());
                    if (!t10.isEmpty()) {
                        s.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((n) t10.get(0)).f30166a);
                    }
                }
                e(str, t10);
                C4770v z12 = C4770v.z(t10);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x008c, code lost:
        if (r1.f30260b == false) goto L_0x008e;
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList t(C9.v.b r24, C9.v.d r25) {
        /*
            r1 = r24
            r2 = r25
            ...
            java.lang.String r15 = r1.f30259a     // Catch:{ Exception -> 0x012e }
        ...
        L_0x0019:
            ...
            boolean r6 = A(r0)     // Catch:{ Exception -> 0x012e }
        ...
        L_0x002d:
            ...
            boolean r6 = C(r0, r11, r13, r15)     // Catch:{ Exception -> 0x012e }
            if (r6 != 0) goto L_0x0038
            goto L_0x0025
        L_0x0038:
            java.lang.String r10 = p(r0, r11, r15)     // Catch:{ Exception -> 0x012e }
        ...
        L_0x003f:
            ...
            boolean r8 = r1.f30261c     // Catch:{ Exception -> 0x007c }
        ...
        L_0x0056:
            ...
            boolean r8 = r1.f30260b     // Catch:{ Exception -> 0x007c }
        ...
        L_0x0064:
            ...
            goto L_0x0025
        L_0x0069:
            boolean r16 = D(r0, r15)     // Catch:{ Exception -> 0x007c }
            boolean r17 = F(r0, r15)     // Catch:{ Exception -> 0x007c }
            boolean r0 = H(r0)     // Catch:{ Exception -> 0x007c }
            if (r13 == 0) goto L_0x0088
            boolean r7 = r1.f30260b     // Catch:{ Exception -> 0x007c }
        ...
        L_0x0088:
            ...
            boolean r7 = r1.f30260b     // Catch:{ Exception -> 0x00c0 }
        ...
        L_0x008e:
            ...
            r18 = r14
            r14 = r19
            C9.n r0 = C9.n.C(r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ Exception -> 0x00b1 }
        ...
        L_0x00cc:
            ...
            r1 = r14
            r14 = r19
            C9.n r0 = C9.n.C(r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ Exception -> 0x00f9 }
        ...
        L_0x00fb:
            ...
            r1 = r14
        L_0x00fd:
            int r6 = ja.M.f44981a     // Catch:{ Exception -> 0x012e }
            r7 = 23
            ...
            ja.s.c(r8, r0)     // Catch:{ Exception -> 0x012e }
        L_0x0124:
            int r12 = r22 + 1
            r1 = r24
            r14 = r18
        ...
        L_0x0130:
            ...
            ja.s.c(r8, r1)     // Catch:{ Exception -> 0x012e }
            throw r0     // Catch:{ Exception -> 0x012e }
        L_0x0154:
            return r5
        L_0x0155:
            C9.v$c r1 = new C9.v$c
            r2 = 0
            r1.<init>(r0)
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: C9.v.t(C9.v$b, C9.v$d):java.util.ArrayList");
    }

    public static List u(List list, C3717q0 q0Var) {
        ArrayList arrayList = new ArrayList(list);
        P(arrayList, new t(q0Var));
        return arrayList;
    }
    ...
    private static Pair w(String str, String[] strArr) {
        if (strArr.length < 3) {
            s.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        Matcher matcher = f30256a.matcher(strArr[1]);
        if (!matcher.matches()) {
            s.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        Integer k10 = k(group);
        if (k10 == null) {
            s.i("MediaCodecUtil", "Unknown Dolby Vision profile string: " + group);
            return null;
        }
        ...
        s.i("MediaCodecUtil", "Unknown Dolby Vision level string: " + str2);
        return null;
    }

    private static Pair x(String str, String[] strArr) {
        if (strArr.length < 4) {
            s.i("MediaCodecUtil", "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i10 = 1;
        Matcher matcher = f30256a.matcher(strArr[1]);
        ...
        if (!"1".equals(group)) {
            if ("2".equals(group)) {
                ...
                s.i("MediaCodecUtil", "Unknown HEVC profile string: " + group);
                return null;
            }
        }
        ...
        s.i("MediaCodecUtil", "Unknown HEVC level string: " + str2);
        return null;
    }

    private static Pair y(String str, String[] strArr) {
        if (strArr.length < 3) {
            s.i("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            int parseInt = Integer.parseInt(strArr[1]);
            ...
            int R10 = R(parseInt);
            if (R10 == -1) {
                s.i("MediaCodecUtil", "Unknown VP9 profile: " + parseInt);
                return null;
            }
            int Q10 = Q(parseInt2);
            if (Q10 != -1) {
                return new Pair(Integer.valueOf(R10), Integer.valueOf(Q10));
            }
            s.i("MediaCodecUtil", "Unknown VP9 level: " + parseInt2);
            return null;
        } catch (NumberFormatException unused) {
            s.i("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
