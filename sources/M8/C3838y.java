...
public interface C3838y {
    ...
    void setAllowsPictureInPictureMediaPlayback(View view, boolean z10);
    ...
    void setPaymentRequestEnabled(View view, boolean z10);

    void setPullToRefreshEnabled(View view, boolean z10);

    void setRefreshControlLightMode(View view, boolean z10);
