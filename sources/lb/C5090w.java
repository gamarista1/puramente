...
public abstract class C5090w {

    /* renamed from: a  reason: collision with root package name */
    private static final C5076i f60998a = new C5076i("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                    f60998a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
                    for (Signature byteArray : signatureArr) {
                        String a10 = C5089v.a(byteArray.toByteArray());
