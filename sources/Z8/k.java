...
class k implements e {
    ...
    private final a f35974a;

    /* renamed from: b  reason: collision with root package name */
    private final i f35975b;

    /* renamed from: c  reason: collision with root package name */
    private final Map f35976c;
        ...
        private Map a(Context context) {
            ...
            for (String next : d10.keySet()) {
                ...
                if ((obj instanceof String) && next.startsWith("backend:")) {
                    for (String trim : ((String) obj).split(f.f37529a, -1)) {
    ...
    public synchronized m get(String str) {
        if (this.f35976c.containsKey(str)) {
            return (m) this.f35976c.get(str);
        }
        d b10 = this.f35974a.b(str);
        if (b10 == null) {
            return null;
        }
        m create = b10.create(this.f35975b.a(str));
        this.f35976c.put(str, create);
        return create;
    }

    k(a aVar, i iVar) {
        this.f35976c = new HashMap();
        this.f35974a = aVar;
        this.f35975b = iVar;
    }
}
