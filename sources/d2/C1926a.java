...
public final class C1926a {
    ...
    private static final Object f19448f = new Object();

    /* renamed from: g  reason: collision with root package name */
    private static C1926a f19449g;

    /* renamed from: a  reason: collision with root package name */
    private final Context f19450a;

    /* renamed from: b  reason: collision with root package name */
    private final HashMap f19451b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap f19452c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList f19453d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    private final Handler f19454e;

    /* renamed from: d2.a$a  reason: collision with other inner class name */
    class C0338a extends Handler {
        C0338a(Looper looper) {
            super(looper);
        }
    ...
    private static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Intent f19456a;

        /* renamed from: b  reason: collision with root package name */
        final ArrayList f19457b;

        b(Intent intent, ArrayList arrayList) {
            this.f19456a = intent;
            this.f19457b = arrayList;
        }
    }
    ...
    private static final class c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f19458a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f19459b;
        ...
        c(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f19458a = intentFilter;
            this.f19459b = broadcastReceiver;
        }
    ...
    private C1926a(Context context) {
        this.f19450a = context;
        this.f19454e = new C0338a(context.getMainLooper());
    }

    public static C1926a b(Context context) {
        C1926a aVar;
        synchronized (f19448f) {
            try {
                if (f19449g == null) {
                    f19449g = new C1926a(context.getApplicationContext());
                }
                aVar = f19449g;
            } catch (Throwable th2) {
                throw th2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x002b, code lost:
        r7 = (d2.C1926a.c) r4.f19457b.get(r6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0035, code lost:
        if (r7.f19461d != false) goto L_0x0040;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0037, code lost:
        r7.f19459b.onReceive(r10.f19450a, r4.f19456a);
     */
    ...
    public void a() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap r0 = r10.f19451b
            monitor-enter(r0)
            java.util.ArrayList r1 = r10.f19453d     // Catch:{ all -> 0x000d }
        ...
        L_0x000d:
            ...
            goto L_0x0046
        L_0x000f:
            d2.a$b[] r2 = new d2.C1926a.b[r1]     // Catch:{ all -> 0x000d }
            java.util.ArrayList r3 = r10.f19453d     // Catch:{ all -> 0x000d }
        ...
        L_0x001e:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList r5 = r4.f19457b
            int r5 = r5.size()
            r6 = r0
        L_0x0029:
            if (r6 >= r5) goto L_0x0043
            java.util.ArrayList r7 = r4.f19457b
            java.lang.Object r7 = r7.get(r6)
            d2.a$c r7 = (d2.C1926a.c) r7
            boolean r8 = r7.f19461d
            if (r8 != 0) goto L_0x0040
            android.content.BroadcastReceiver r7 = r7.f19459b
            android.content.Context r8 = r10.f19450a
            android.content.Intent r9 = r4.f19456a
            r7.onReceive(r8, r9)
        L_0x0040:
            int r6 = r6 + 1
            goto L_0x0029
        ...
        L_0x0046:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: d2.C1926a.a():void");
    }
    ...
    public void c(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f19451b) {
            try {
                ...
                ArrayList arrayList = (ArrayList) this.f19451b.get(broadcastReceiver);
                if (arrayList == null) {
                    arrayList = new ArrayList(1);
                    this.f19451b.put(broadcastReceiver, arrayList);
                }
                arrayList.add(cVar);
                for (int i10 = 0; i10 < intentFilter.countActions(); i10++) {
                    String action = intentFilter.getAction(i10);
                    ArrayList arrayList2 = (ArrayList) this.f19452c.get(action);
                    if (arrayList2 == null) {
                        arrayList2 = new ArrayList(1);
                        this.f19452c.put(action, arrayList2);
                    }
                    arrayList2.add(cVar);
                }
            } catch (Throwable th2) {
    ...
    public boolean d(android.content.Intent r22) {
        /*
            ...
            r1 = r21
            r0 = r22
            java.util.HashMap r2 = r1.f19451b
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0057 }
            android.content.Context r3 = r1.f19450a     // Catch:{ all -> 0x0057 }
        ...
        L_0x0057:
            ...
            goto L_0x0179
        L_0x005a:
            java.util.HashMap r3 = r1.f19452c     // Catch:{ all -> 0x0057 }
        ...
        L_0x0084:
            ...
            r5 = r3
            d2.a$c r5 = (d2.C1926a.c) r5     // Catch:{ all -> 0x0057 }
            ...
            android.content.IntentFilter r9 = r5.f19458a     // Catch:{ all -> 0x0057 }
            r4.append(r9)     // Catch:{ all -> 0x0057 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0057 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0057 }
        L_0x00ab:
            boolean r3 = r5.f19460c     // Catch:{ all -> 0x0057 }
        ...
        L_0x00b8:
            ...
            goto L_0x013b
        L_0x00c4:
            android.content.IntentFilter r3 = r5.f19458a     // Catch:{ all -> 0x0057 }
        ...
        L_0x0103:
            ...
            r15.f19460c = r11     // Catch:{ all -> 0x0057 }
            goto L_0x013c
        L_0x0109:
        ...
        L_0x014b:
            ...
            d2.a$c r4 = (d2.C1926a.c) r4     // Catch:{ all -> 0x0057 }
            r5 = 0
            r4.f19460c = r5     // Catch:{ all -> 0x0057 }
            int r3 = r3 + 1
            goto L_0x014b
        L_0x015d:
            java.util.ArrayList r3 = r1.f19453d     // Catch:{ all -> 0x0057 }
            d2.a$b r4 = new d2.a$b     // Catch:{ all -> 0x0057 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0057 }
            r3.add(r4)     // Catch:{ all -> 0x0057 }
            android.os.Handler r0 = r1.f19454e     // Catch:{ all -> 0x0057 }
        ...
        L_0x0179:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: d2.C1926a.d(android.content.Intent):boolean");
    }

    public void e(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f19451b) {
            try {
                ArrayList arrayList = (ArrayList) this.f19451b.remove(broadcastReceiver);
                if (arrayList != null) {
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        c cVar = (c) arrayList.get(size);
                        cVar.f19461d = true;
                        for (int i10 = 0; i10 < cVar.f19458a.countActions(); i10++) {
                            String action = cVar.f19458a.getAction(i10);
                            ArrayList arrayList2 = (ArrayList) this.f19452c.get(action);
                            if (arrayList2 != null) {
                                for (int size2 = arrayList2.size() - 1; size2 >= 0; size2--) {
                                    c cVar2 = (c) arrayList2.get(size2);
                                    if (cVar2.f19459b == broadcastReceiver) {
                                        cVar2.f19461d = true;
                                        arrayList2.remove(size2);
                                    }
                                }
                                if (arrayList2.size() <= 0) {
                                    this.f19452c.remove(action);
                                }
                            }
                        }
                    }
