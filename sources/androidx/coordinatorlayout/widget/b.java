...
public abstract class b {
    ...
    private static final ThreadLocal f15737a = new ThreadLocal();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal f15738b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f15737a;
        ...
        ThreadLocal threadLocal2 = f15738b;
