...
public abstract class a {
    ...
    protected final C1587a f18482a;

    /* renamed from: b  reason: collision with root package name */
    protected final C1587a f18483b;

    /* renamed from: c  reason: collision with root package name */
    protected final C1587a f18484c;

    public a(C1587a aVar, C1587a aVar2, C1587a aVar3) {
        this.f18482a = aVar;
        this.f18483b = aVar2;
        this.f18484c = aVar3;
    }
    ...
    private Class c(Class cls) {
        Class cls2 = (Class) this.f18484c.get(cls.getName());
        if (cls2 != null) {
            return cls2;
        }
        Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", new Object[]{cls.getPackage().getName(), cls.getSimpleName()}), false, cls.getClassLoader());
        this.f18484c.put(cls.getName(), cls3);
        return cls3;
    }

    private Method d(String str) {
        Method method = (Method) this.f18482a.get(str);
        if (method != null) {
            return method;
        }
        ...
        this.f18482a.put(str, declaredMethod);
        return declaredMethod;
    }

    private Method e(Class cls) {
        Method method = (Method) this.f18483b.get(cls.getName());
        if (method != null) {
            return method;
        }
        Class c10 = c(cls);
        ...
        this.f18483b.put(cls.getName(), declaredMethod);
        return declaredMethod;
    }
    ...
    public void K(b bVar, a aVar) {
        try {
            e(bVar.getClass()).invoke((Object) null, new Object[]{bVar, aVar});
