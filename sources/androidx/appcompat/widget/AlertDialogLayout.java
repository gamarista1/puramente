...
public class AlertDialogLayout extends S {
    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == C2042f.f21367Q) {
                    view = childAt;
                } else if (id2 == C2042f.f21379l) {
                    view2 = childAt;
                } else if ((id2 != C2042f.f21381n && id2 != C2042f.f21383p) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    private void l(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                S.a aVar = (S.a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i13 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.S$a r15 = (androidx.appcompat.widget.S.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = r17.getLayoutDirection()
            int r2 = androidx.core.view.C1712s.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
