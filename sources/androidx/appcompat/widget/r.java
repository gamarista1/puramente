...
public class r extends MultiAutoCompleteTextView {
    ...
    private static final int[] f11997d = {16843126};

    /* renamed from: a  reason: collision with root package name */
    private final C1566e f11998a;

    /* renamed from: b  reason: collision with root package name */
    private final B f11999b;

    /* renamed from: c  reason: collision with root package name */
    private final C1574m f12000c;
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f12000c.d(C1576o.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f12000c.a(keyListener));
    }
    ...
    public r(Context context, AttributeSet attributeSet, int i10) {
        ...
        g0 v10 = g0.v(getContext(), attributeSet, f11997d, i10, 0);
        if (v10.s(0)) {
