...
class C1580t {
    ...
    private static final int[] f12006c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f12007a;

    /* renamed from: b  reason: collision with root package name */
    private Bitmap f12008b;
    ...
    C1580t(ProgressBar progressBar) {
    ...
    public void c(AttributeSet attributeSet, int i10) {
        g0 v10 = g0.v(this.f12007a.getContext(), attributeSet, f12006c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f12007a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f12007a.setProgressDrawable(d(h11, false));
        }
        v10.x();
    }
