...
public final class H extends N {
    ...
    private final void h() {
        if (this.f12109d <= 8 || Long.compare(C6508G.b(C6508G.b((long) this.f12110e) * 32) ^ Long.MIN_VALUE, C6508G.b(C6508G.b((long) this.f12109d) * 25) ^ Long.MIN_VALUE) > 0) {
            q(V.e(this.f12109d));
        } else {
            i();
        }
    ...
    private final void i() {
        ...
        int i13 = this.f12109d;
        Object[] objArr2 = this.f12107b;
    ...
    private final int k(Object obj) {
        ...
        while (true) {
            ...
            for (long j13 = (~j12) & (j12 - 72340172838076673L) & -9187201950435737472L; j13 != 0; j13 &= j13 - 1) {
                ...
                if (C6496s.c(this.f12107b[numberOfTrailingZeros], obj2)) {
                    return numberOfTrailingZeros;
                }
            }
            if ((((~j10) << 6) & j10 & -9187201950435737472L) != 0) {
                int j14 = j(i14);
                if (this.f12081f == 0 && ((this.f12106a[j14 >> 3] >> ((j14 & 7) << 3)) & 255) != 254) {
                    h();
                    j14 = j(i14);
                }
                this.f12110e++;
                int i22 = this.f12081f;
                long[] jArr2 = this.f12106a;
                int i23 = j14 >> 3;
                long j15 = jArr2[i23];
                int i24 = (j14 & 7) << 3;
                if (((j15 >> i24) & 255) == 128) {
                ...
                this.f12081f = i22 - i11;
                int i25 = this.f12109d;
    ...
    private final void l() {
        this.f12081f = V.c(c()) - this.f12110e;
    }
    ...
    private final void n(int i10) {
        ...
        this.f12109d = i11;
        m(i11);
        this.f12107b = new Object[i11];
        this.f12108c = new int[i11];
    }
    ...
    private final void q(int i10) {
        ...
        long[] jArr2 = this.f12106a;
        Object[] objArr2 = this.f12107b;
        int[] iArr2 = this.f12108c;
        int i14 = this.f12109d;
        int i15 = 0;
        while (i15 < i13) {
    ...
    public final int o(Object obj, int i10, int i11) {
        ...
        if (k10 < 0) {
            ...
            i11 = this.f12108c[k10];
        }
        this.f12107b[k10] = obj;
        this.f12108c[k10] = i10;
        return i11;
    }
