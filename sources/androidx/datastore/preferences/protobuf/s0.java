...
interface s0 {
    ...
    void J(int i10, List list, e0 e0Var);

    void K(int i10, C1734g gVar);

    void L(int i10, Object obj, e0 e0Var);

    void M(int i10, H.a aVar, Map map);

    void N(int i10, Object obj, e0 e0Var);

    void O(int i10, List list, e0 e0Var);
