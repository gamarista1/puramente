...
public final class C1840g {
    ...
    private static final String f18736b = s.i("Data");

    /* renamed from: c  reason: collision with root package name */
    public static final C1840g f18737c = new a().a();
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Map f18739a = new HashMap();

        public C1840g a() {
            C1840g gVar = new C1840g(this.f18739a);
            C1840g.k(gVar);
            return gVar;
        }
        ...
        public a b(String str, Object obj) {
            if (obj == null) {
                this.f18739a.put(str, (Object) null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                    this.f18739a.put(str, obj);
                } else if (cls == boolean[].class) {
                    this.f18739a.put(str, C1840g.a((boolean[]) obj));
                } else if (cls == byte[].class) {
                    this.f18739a.put(str, C1840g.b((byte[]) obj));
                } else if (cls == int[].class) {
                    this.f18739a.put(str, C1840g.e((int[]) obj));
                } else if (cls == long[].class) {
                    this.f18739a.put(str, C1840g.f((long[]) obj));
                } else if (cls == float[].class) {
                    this.f18739a.put(str, C1840g.d((float[]) obj));
                } else if (cls == double[].class) {
                    this.f18739a.put(str, C1840g.c((double[]) obj));
                } else {
    ...
    public C1840g(C1840g gVar) {
        this.f18738a = new HashMap(gVar.f18738a);
    }
    ...
    public static androidx.work.C1840g g(byte[] r7) {
        /*
        ...
        L_0x004f:
            ...
            goto L_0x004b
        L_0x0051:
            java.lang.String r4 = f18736b     // Catch:{ all -> 0x002b }
        ...
        L_0x0082:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.C1840g.g(byte[]):androidx.work.g");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] k(androidx.work.C1840g r5) {
        /*
            ...
            java.util.Map r5 = r5.f18738a     // Catch:{ IOException -> 0x003e, all -> 0x003b }
        ...
        L_0x006c:
            r5 = move-exception
        L_0x006d:
            java.lang.String r3 = f18736b     // Catch:{ all -> 0x006a }
        ...
        L_0x00a3:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.C1840g.k(androidx.work.g):byte[]");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || C1840g.class != obj.getClass()) {
            return false;
        }
        C1840g gVar = (C1840g) obj;
        Set<String> keySet = this.f18738a.keySet();
        if (!keySet.equals(gVar.f18738a.keySet())) {
            return false;
        }
        for (String str : keySet) {
            Object obj2 = this.f18738a.get(str);
            Object obj3 = gVar.f18738a.get(str);
    ...
    public Map h() {
        return Collections.unmodifiableMap(this.f18738a);
    }
    ...
    public String i(String str) {
        Object obj = this.f18738a.get(str);
    ...
    public String toString() {
        ...
        if (!this.f18738a.isEmpty()) {
            for (String str : this.f18738a.keySet()) {
                sb2.append(str);
                sb2.append(" : ");
                Object obj = this.f18738a.get(str);
    ...
    public C1840g(Map map) {
        this.f18738a = new HashMap(map);
    }
}
