...
public final class o extends SpannableStringBuilder {
    ...
    private final List f16671b = new ArrayList();

    private static class a implements TextWatcher, SpanWatcher {

        /* renamed from: a  reason: collision with root package name */
        final Object f16672a;

        /* renamed from: b  reason: collision with root package name */
        private final AtomicInteger f16673b = new AtomicInteger(0);
        ...
        public final void a() {
            this.f16673b.incrementAndGet();
        }

        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f16672a).afterTextChanged(editable);
        }

        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f16672a).beforeTextChanged(charSequence, i10, i11, i12);
        }

        /* access modifiers changed from: package-private */
        public final void c() {
            this.f16673b.decrementAndGet();
        }

        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f16673b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f16672a).onSpanAdded(spannable, obj, i10, i11);
            }
        }
            ...
            if (this.f16673b.get() <= 0 || !b(obj)) {
                if (Build.VERSION.SDK_INT < 28) {
                    ...
                    if (i12 > i13) {
                        i15 = i10;
                        i14 = 0;
                        ((SpanWatcher) this.f16672a).onSpanChanged(spannable, obj, i15, i11, i14, i13);
                    }
                }
                i15 = i10;
                i14 = i12;
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f16673b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f16672a).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f16672a).onTextChanged(charSequence, i10, i11, i12);
        }
    }

    o(Class cls, CharSequence charSequence) {
        super(charSequence);
        g.g(cls, "watcherClass cannot be null");
        this.f16670a = cls;
    }

    private void b() {
        for (int i10 = 0; i10 < this.f16671b.size(); i10++) {
            ((a) this.f16671b.get(i10)).a();
        }
    }
    ...
    private void e() {
        for (int i10 = 0; i10 < this.f16671b.size(); i10++) {
            ((a) this.f16671b.get(i10)).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f16671b.size(); i10++) {
            a aVar = (a) this.f16671b.get(i10);
            if (aVar.f16672a == obj) {
                return aVar;
            }
        }
    ...
    public Object[] getSpans(int i10, int i11, Class cls) {
        ...
        for (int i12 = 0; i12 < aVarArr.length; i12++) {
            objArr[i12] = aVarArr[i12].f16672a;
        }
        return objArr;
    }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new o(this.f16670a, this, i10, i11);
    }
