...
public final class e extends r implements L {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0049:
                int[] r0 = f50332a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: Bc.e.a.<clinit>():void");
        }
    }
    ...
    public static final class b extends r.a implements L {
        ...
        public b A(long j10) {
            t();
            ((e) this.f58648b).Z(j10);
            return this;
        }

        public b B(long j10) {
            t();
            ((e) this.f58648b).a0(j10);
            return this;
        }

        public b z(long j10) {
            t();
            ((e) this.f58648b).Y(j10);
            return this;
        }
