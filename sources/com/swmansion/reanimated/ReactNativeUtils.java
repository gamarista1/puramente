        ...
        if (view instanceof h) {
            try {
                ...
                if (mBorderRadiusField == null) {
                    Field declaredField = cls.getDeclaredField("mBorderRadius");
                    mBorderRadiusField = declaredField;
                    declaredField.setAccessible(true);
                }
                float f10 = mBorderRadiusField.getFloat(view);
                if (getCornerRadiiMethod == null) {
                    Method declaredMethod = cls.getDeclaredMethod("getCornerRadii", new Class[]{float[].class});
                ...
                getCornerRadiiMethod.invoke(view, new Object[]{fArr});
