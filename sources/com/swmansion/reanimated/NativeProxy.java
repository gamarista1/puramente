...
public class NativeProxy extends NativeProxyCommon {
    ...
    public NativeProxy(ReactApplicationContext reactApplicationContext, String str) {
        ...
        FabricUIManager fabricUIManager = (FabricUIManager) n0.g(reactApplicationContext, 2);
        ...
        if (reactApplicationContext.isBridgeless()) {
            ...
            this.mHybridData = initHybrid(javaScriptContextHolder2.get(), (CallInvokerHolderImpl) reactApplicationContext.getJSCallInvokerHolder(), this.mAndroidUIScheduler, layoutAnimations, reanimatedMessageQueueThread, fabricUIManager, str);
        }
