...
public class PerformanceModule extends ReactContextBaseJavaModule {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0138 }
            ...
            L_0x0138:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0144 }
            ...
            L_0x0144:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0150 }
            ...
            L_0x0150:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x015c }
            ...
            L_0x015c:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0168 }
            ...
            L_0x0168:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0174 }
            ...
            L_0x0174:
                int[] r0 = f59172a     // Catch:{ NoSuchFieldError -> 0x0180 }
            ...
            L_0x0180:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.oblador.performance.PerformanceModule.a.<clinit>():void");
        }
    }
    ...
    private void emit(String str, String str2, long j10) {
        ...
        createMap.putInt("startTime", (int) j10);
    ...
    private static long getStartTime(int i10) {
        BufferedReader bufferedReader = new BufferedReader(new FileReader("/proc/" + i10 + "/stat"));
        try {
            String readLine = bufferedReader.readLine();
            bufferedReader.close();
            try {
                return (Long.parseLong(readLine.substring(readLine.lastIndexOf(") ")).split(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR)[20]) * 1000) / Os.sysconf(OsConstants._SC_CLK_TCK);
            } catch (Exception e10) {
    ...
    public static /* synthetic */ void lambda$setupListener$0(ReactMarkerConstants reactMarkerConstants, String str, int i10) {
        switch (a.f59172a[reactMarkerConstants.ordinal()]) {
            case 1:
            case 3:
            case 4:
            case 5:
    ...
    public /* synthetic */ void lambda$setupMarkerListener$1(ReactMarkerConstants reactMarkerConstants, String str, int i10) {
        int i11 = a.f59172a[reactMarkerConstants.ordinal()];
        if (i11 == 1) {
    ...
    public static void setupListener() {
        ReactMarker.addListener(new C5050b());
    }

    private void setupMarkerListener() {
        ReactMarker.addListener(new C5049a(this));
    }
