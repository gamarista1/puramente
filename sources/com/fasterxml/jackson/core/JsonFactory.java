...
public class JsonFactory implements Versioned, Serializable {
    ...
    /* access modifiers changed from: protected */
    public JsonParser _createParser(char[] cArr, int i10, int i11, IOContext iOContext, boolean z10) {
        return new ReaderBasedJsonParser(iOContext, this._parserFeatures, (Reader) null, this._objectCodec, this._rootCharSymbols.makeChild(this._factoryFeatures), cArr, i10, i10 + i11, z10);
    }
    ...
    /* access modifiers changed from: protected */
    public JsonParser _createParser(byte[] bArr, int i10, int i11, IOContext iOContext) {
    ...
    public JsonParser _createParser(DataInput dataInput, IOContext iOContext) {
        ...
        throw new UnsupportedOperationException(String.format("InputData source not (yet?) support for this format (%s)", new Object[]{formatName}));
    }
    ...
    @Deprecated
    public JsonParser createJsonParser(byte[] bArr, int i10, int i11) {
    ...
    public JsonParser createParser(byte[] bArr, int i10, int i11) {
        ...
        IOContext _createContext = _createContext(bArr, true);
        InputDecorator inputDecorator = this._inputDecorator;
        if (inputDecorator == null || (decorate = inputDecorator.decorate(_createContext, bArr, i10, i11)) == null) {
            return _createParser(bArr, i10, i11, _createContext);
        }
        return _createParser(decorate, _createContext);
    }
