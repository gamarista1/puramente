...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
                        ...
                        if (set == null || !set.contains(currentName)) {
                            ...
                            if (settableAnyProperty != null) {
                                try {
                                    ...
                                    wrapAndThrow((Throwable) e11, (Object) this._beanType.getRawClass(), currentName, deserializationContext);
                                }
                            } else {
                                if (tokenBuffer == null) {
    ...
    public final Object _deserializeWithErrorWrapping(JsonParser jsonParser, DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty) {
        try {
            ...
            wrapAndThrow((Throwable) e10, (Object) this._beanType.getRawClass(), settableBeanProperty.getName(), deserializationContext);
            return null;
        }
    }
            ...
            if (findCreatorProperty != null) {
                if (startBuilding.assignParameter(findCreatorProperty, _deserializeWithErrorWrapping(jsonParser, deserializationContext, findCreatorProperty))) {
                    ...
                    try {
                        ...
                        obj = wrapInstantiationProblem(e10, deserializationContext);
                    }
                ...
                if (find != null) {
                    ...
                    if (set != null && set.contains(currentName)) {
                        ...
                        try {
                            ...
                            asParser.nextToken();
                            SettableAnyProperty settableAnyProperty = this._anySetter;
                            startBuilding.bufferAnyProperty(settableAnyProperty, currentName, settableAnyProperty.deserialize(asParser, deserializationContext));
                        } catch (Exception e11) {
                            wrapAndThrow((Throwable) e11, (Object) this._beanType.getRawClass(), currentName, deserializationContext);
                        }
                    }
            ...
            if (find == null) {
                ...
                if (set != null && set.contains(str)) {
                    ...
                    try {
                        ...
                        wrapAndThrow((Throwable) e10, createUsingDefault, str, deserializationContext);
                    }
                }
                ...
                try {
                    ...
                    wrapAndThrow((Throwable) e11, createUsingDefault, str, deserializationContext);
                }
            } else {
