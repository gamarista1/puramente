...
public class BeanDeserializerBuilder {
    ...
    public JsonDeserializer<?> build() {
        ...
        return new BeanDeserializer(this, this._beanDesc, construct, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, z11);
    }
    ...
    public JsonDeserializer<?> buildBuilderBased(JavaType javaType, String str) {
        ...
        return new BuilderBasedDeserializer(this, this._beanDesc, construct, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, z11);
    }
