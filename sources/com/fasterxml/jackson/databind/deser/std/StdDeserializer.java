...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> implements Serializable {
    ...
    public final Boolean _parseBoolean(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            if (b.f37475af.equals(trim) || "True".equals(trim)) {
                return Boolean.TRUE;
            }
            if (b.f37476ag.equals(trim) || "False".equals(trim)) {
                return Boolean.FALSE;
            }
            if (trim.length() == 0) {
    ...
    /* access modifiers changed from: protected */
    @Deprecated
    public boolean _parseBooleanFromOther(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public final boolean _parseBooleanPrimitive(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            if (b.f37476ag.equals(trim) || "False".equals(trim) || trim.length() == 0 || _hasTextualNull(trim) || (bool = (Boolean) deserializationContext.handleWeirdStringValue(this._valueClass, trim, "only \"true\" or \"false\" recognized", new Object[0])) == null) {
                return false;
            }
        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (length > 9) {
                    ...
                    Number number = (Number) deserializationContext.handleWeirdStringValue(this._valueClass, trim, "Overflow: numeric value (%s) out of range of int (%d -%d)", trim, Integer.MIN_VALUE, Integer.valueOf(a.e.API_PRIORITY_OTHER));
                    if (number == null) {
                        return 0;
                    }
            ...
            if (currentTokenId == 6) {
                ...
                try {
                    ...
                    if (length > 9) {
                        ...
                        return (Integer) deserializationContext.handleWeirdStringValue(cls, trim, "Overflow: numeric value (" + trim + ") out of range of Integer (" + Integer.MIN_VALUE + " - " + a.e.API_PRIORITY_OTHER + ")", new Object[0]);
                    } else if (length == 0) {
    ...
    public Date _parseDate(String str, DeserializationContext deserializationContext) {
        try {
            ...
            return (Date) deserializationContext.handleWeirdStringValue(this._valueClass, str, "not a valid representation (error: %s)", e10.getMessage());
        }
    }
}
