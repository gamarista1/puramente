...
public class StdValueInstantiator extends ValueInstantiator implements Serializable {
        ...
        if (annotatedWithParams == null) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (settableBeanProperty == null) {
                    ...
                    objArr[i10] = deserializationContext.findInjectableValue(settableBeanProperty.getInjectableValueId(), settableBeanProperty, (Object) null);
                }
            }
    ...
    public Object createFromObjectWith(DeserializationContext deserializationContext, Object[] objArr) {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._withArgsCreator.getDeclaringClass(), objArr, rewrapCtorProblem(deserializationContext, th2));
        }
    }
    ...
    public Object createUsingDefault(DeserializationContext deserializationContext) {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._defaultCreator.getDeclaringClass(), (Object) null, rewrapCtorProblem(deserializationContext, th2));
        }
    }
