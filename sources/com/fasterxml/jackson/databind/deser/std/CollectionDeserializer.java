...
public class CollectionDeserializer extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer {
    ...
    public final Collection<Object> handleNonArray(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<Object> collection) {
        ...
        try {
            ...
            throw JsonMappingException.wrapWithPath((Throwable) e10, (Object) Object.class, collection.size());
        }
    }
    ...
    public com.fasterxml.jackson.databind.deser.std.CollectionDeserializer createContextual(com.fasterxml.jackson.databind.DeserializationContext r5, com.fasterxml.jackson.databind.BeanProperty r6) {
        /*
            r4 = this;
    ...
    public Collection<Object> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<Object> collection) {
        ...
        while (true) {
            ...
            try {
                ...
                if (deserializationContext == null || deserializationContext.isEnabled(DeserializationFeature.WRAP_EXCEPTIONS) || !(e11 instanceof RuntimeException)) {
                    throw JsonMappingException.wrapWithPath((Throwable) e11, (Object) collection, collection.size());
                }
