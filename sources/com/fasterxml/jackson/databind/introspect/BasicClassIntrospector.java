...
public class BasicClassIntrospector extends ClassIntrospector implements Serializable {
    ...
    static {
        ...
        STRING_DESC = BasicBeanDescription.forOtherUse((MapperConfig<?>) null, SimpleType.constructUnsafe(cls), AnnotatedClass.constructWithoutSuperTypes(cls, (MapperConfig<?>) null));
        Class cls2 = Boolean.TYPE;
        BOOLEAN_DESC = BasicBeanDescription.forOtherUse((MapperConfig<?>) null, SimpleType.constructUnsafe(cls2), AnnotatedClass.constructWithoutSuperTypes(cls2, (MapperConfig<?>) null));
        Class cls3 = Integer.TYPE;
        INT_DESC = BasicBeanDescription.forOtherUse((MapperConfig<?>) null, SimpleType.constructUnsafe(cls3), AnnotatedClass.constructWithoutSuperTypes(cls3, (MapperConfig<?>) null));
        Class cls4 = Long.TYPE;
        LONG_DESC = BasicBeanDescription.forOtherUse((MapperConfig<?>) null, SimpleType.constructUnsafe(cls4), AnnotatedClass.constructWithoutSuperTypes(cls4, (MapperConfig<?>) null));
    }
    ...
    public POJOPropertiesCollector collectProperties(MapperConfig<?> mapperConfig, JavaType javaType, ClassIntrospector.MixInResolver mixInResolver, boolean z10, String str) {
        return constructPropertyCollector(mapperConfig, AnnotatedClass.construct(javaType, mapperConfig, mixInResolver), javaType, z10, str);
    }
    ...
    public POJOPropertiesCollector collectPropertiesWithBuilder(MapperConfig<?> mapperConfig, JavaType javaType, ClassIntrospector.MixInResolver mixInResolver, boolean z10) {
        ...
        return constructPropertyCollector(mapperConfig, construct, javaType, z10, str);
    }
