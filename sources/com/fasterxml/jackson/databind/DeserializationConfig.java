...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable {
    ...
    public final boolean hasDeserializationFeatures(int i10) {
        if ((this._deserFeatures & i10) == i10) {
            return true;
        }
        return false;
    }
    ...
    public DeserializationConfig withFeatures(DeserializationFeature... deserializationFeatureArr) {
        ...
        if (i11 == this._deserFeatures) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, i11, this._parserFeatures, this._parserFeaturesToChange, this._formatReadFeatures, this._formatReadFeaturesToChange);
    }
    ...
    public DeserializationConfig without(MapperFeature... mapperFeatureArr) {
        ...
        return new DeserializationConfig(this, i11, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, this._formatReadFeatures, this._formatReadFeaturesToChange);
    }
    ...
    public com.fasterxml.jackson.annotation.JsonInclude.Value getDefaultPropertyInclusion(java.lang.Class<?> r1, com.fasterxml.jackson.annotation.JsonInclude.Value r2) {
        ...
        L_0x000d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.DeserializationConfig.getDefaultPropertyInclusion(java.lang.Class, com.fasterxml.jackson.annotation.JsonInclude$Value):com.fasterxml.jackson.annotation.JsonInclude$Value");
    }
    ...
    public DeserializationConfig withFeatures(JsonParser.Feature... featureArr) {
        ...
        if (this._parserFeatures == i12 && this._parserFeaturesToChange == i13) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, i12, i13, this._formatReadFeatures, this._formatReadFeaturesToChange);
    }
    ...
    public DeserializationConfig without(DeserializationFeature deserializationFeature) {
        ...
        if (i10 == this._deserFeatures) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, i10, this._parserFeatures, this._parserFeaturesToChange, this._formatReadFeatures, this._formatReadFeaturesToChange);
    }
    ...
    public DeserializationConfig withFeatures(FormatFeature... formatFeatureArr) {
        ...
        if (this._formatReadFeatures == i12 && this._formatReadFeaturesToChange == i13) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, i12, i13);
    }
    ...
    public DeserializationConfig without(JsonParser.Feature feature) {
        ...
        if (this._parserFeatures == i10 && this._parserFeaturesToChange == mask) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, i10, mask, this._formatReadFeatures, this._formatReadFeaturesToChange);
    }
    ...
    public DeserializationConfig without(FormatFeature formatFeature) {
        ...
        if (this._formatReadFeatures == i10 && this._formatReadFeaturesToChange == mask) {
            return this;
        }
        return new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, i10, mask);
    }
