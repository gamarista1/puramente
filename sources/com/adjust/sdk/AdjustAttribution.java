...
public class AdjustAttribution implements Serializable {
    ...
    static {
        ...
        serialPersistentFields = new ObjectStreamField[]{new ObjectStreamField("trackerToken", cls), new ObjectStreamField("trackerName", cls), new ObjectStreamField("network", cls), new ObjectStreamField("campaign", cls), new ObjectStreamField("adgroup", cls), new ObjectStreamField("creative", cls), new ObjectStreamField("clickLabel", cls), new ObjectStreamField("costType", cls), new ObjectStreamField("costAmount", Double.class), new ObjectStreamField("costCurrency", cls), new ObjectStreamField("fbInstallReferrer", cls)};
    }
