...
class DeviceInfo {
    ...
    public static class UtilDeviceIds {
        ...
        public static String getMcc(Context context, ILogger iLogger) {
            try {
                String networkOperator = ((TelephonyManager) context.getSystemService(AttributeType.PHONE)).getNetworkOperator();
    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                SigningInfo a10 = context.getPackageManager().getPackageInfo("com.facebook.katana", 134217728).signingInfo;
                signatureArr = a10 != null ? a10.getApkContentsSigners() : null;
            } else {
