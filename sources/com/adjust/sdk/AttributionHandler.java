...
public class AttributionHandler implements IAttributionHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class c implements Runnable {
        ...
        public final /* synthetic */ SessionResponseData f36917a;

        public c(SessionResponseData sessionResponseData) {
            this.f36917a = sessionResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkSessionResponseI(iActivityHandler, this.f36917a);
            }
        }
    }
    ...
    public class d implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ SdkClickResponseData f36919a;

        public d(SdkClickResponseData sdkClickResponseData) {
            this.f36919a = sdkClickResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkSdkClickResponseI(iActivityHandler, this.f36919a);
            }
        }
    }
    ...
    public class e implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ AttributionResponseData f36921a;

        public e(AttributionResponseData attributionResponseData) {
            this.f36921a = attributionResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkAttributionResponseI(iActivityHandler, this.f36921a);
            }
        }
    }
    ...
    public class g implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ ResponseData f36924a;

        public g(ResponseData responseData) {
            this.f36924a = responseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                ResponseData responseData = this.f36924a;
