...
public class TimerCycle {
    ...
    public TimerCycle(Runnable runnable, long j10, long j11, String str) {
        ...
        String format = decimalFormat.format(((double) j11) / 1000.0d);
        this.logger.verbose("%s configured to fire after %s seconds of starting and cycles every %s seconds", str, decimalFormat.format(((double) j10) / 1000.0d), format);
    }
