...
public class PurchaseVerificationHandler implements IPurchaseVerificationHandler {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ ActivityPackage f36950a;

        public a(ActivityPackage activityPackage) {
            this.f36950a = activityPackage;
        }

        public final void run() {
            PurchaseVerificationHandler.this.packageQueue.add(this.f36950a);
            ...
            PurchaseVerificationHandler.this.logger.verbose("%s", this.f36950a.getExtendedString());
    ...
    public class c implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ ActivityPackage f36953a;

        public c(ActivityPackage activityPackage) {
            this.f36953a = activityPackage;
        }

        public final void run() {
            PurchaseVerificationHandler.this.sendPurchaseVerificationPackageI(this.f36953a);
            PurchaseVerificationHandler.this.sendNextPurchaseVerificationPackage();
        }
    }
    ...
    private long waitTime(int i10) {
        ...
        this.logger.verbose("Waiting for %s seconds before retrying purchase_verification for the %d time", Util.SecondsDisplayFormat.format(((double) waitingTime) / MILLISECONDS_TO_SECONDS_DIVISOR), Integer.valueOf(i10));
        return waitingTime;
    }
