...
public class ResponseData {
    ...
    public static ResponseData buildResponseData(ActivityPackage activityPackage2, Map<String, String> map, Map<String, String> map2) {
        ...
        int i10 = a.f36955a[activityKind2.ordinal()];
        ResponseData responseData = i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? i10 != 5 ? new ResponseData() : new PurchaseVerificationResponseData() : new EventResponseData(activityPackage2) : new AttributionResponseData() : new SdkClickResponseData() : new SessionResponseData(activityPackage2);
