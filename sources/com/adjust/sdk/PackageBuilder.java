...
public class PackageBuilder {
    ...
    public static class a {
        ...
        public final int f36934a = -1;

        /* renamed from: b  reason: collision with root package name */
        public final int f36935b = -1;

        /* renamed from: c  reason: collision with root package name */
        public final int f36936c = -1;

        /* renamed from: d  reason: collision with root package name */
        public final long f36937d = -1;

        /* renamed from: e  reason: collision with root package name */
        public final long f36938e = -1;

        /* renamed from: f  reason: collision with root package name */
        public final String f36939f = null;

        /* renamed from: g  reason: collision with root package name */
        public final String f36940g = null;

        public a(ActivityState activityState) {
            if (activityState != null) {
                this.f36934a = activityState.eventCount;
                this.f36935b = activityState.sessionCount;
                this.f36936c = activityState.subsessionCount;
                this.f36937d = activityState.timeSpent;
                this.f36938e = activityState.sessionLength;
                this.f36939f = activityState.uuid;
                this.f36940g = activityState.pushToken;
            }
        }
    }

    public PackageBuilder(AdjustConfig adjustConfig2, DeviceInfo deviceInfo2, ActivityState activityState, GlobalParameters globalParameters2, long j10) {
        this.createdAt = j10;
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue) {
        ...
        addString(hashMap, "android_uuid", this.activityStateCopy.f36939f);
        ...
        addString(hashMap, "push_token", this.activityStateCopy.f36940g);
        ...
        addString(hashMap, b.f37469a, adjustAdRevenue.currency);
        ...
        addLong(hashMap, "session_count", (long) this.activityStateCopy.f36935b);
        addDuration(hashMap, "session_length", this.activityStateCopy.f36938e);
        addLong(hashMap, "subsession_count", (long) this.activityStateCopy.f36936c);
        addDuration(hashMap, "time_spent", this.activityStateCopy.f36937d);
    ...
    private Map<String, String> getClickParameters(String str) {
        ...
        addString(hashMap, "os_version", this.deviceInfo.osVersion);
        addString(hashMap, "package_name", this.deviceInfo.packageName);
        addMapJson(hashMap, RNBranchModule.NATIVE_INIT_SESSION_FINISHED_EVENT_PARAMS, this.extraParameters);
    ...
    private Map<String, String> getSubscriptionParameters(AdjustPlayStoreSubscription adjustPlayStoreSubscription) {
        ...
        addDuration(hashMap, "time_spent", this.activityStateCopy.f36937d);
        addString(hashMap, "updated_at", this.deviceInfo.appUpdateTime);
        addString(hashMap, b.f37469a, adjustPlayStoreSubscription.getCurrency());
        ...
        addString(hashMap, b.f37446D, adjustPlayStoreSubscription.getSignature());
    ...
    private Map<String, String> getVerificationParameters(AdjustEvent adjustEvent) {
        ...
        addString(hashMap, b.f37469a, adjustEvent.getCurrency());
    ...
    public Map<String, String> getEventParameters(AdjustEvent adjustEvent) {
        ...
        addString(hashMap, "cpu_type", this.deviceInfo.abi);
        addDateInMilliseconds(hashMap, "created_at", this.createdAt);
        addString(hashMap, b.f37469a, adjustEvent.currency);
        addBoolean(hashMap, "needs_cost", this.adjustConfig.isCostDataInAttributionEnabled);
        addString(hashMap, "device_manufacturer", this.deviceInfo.deviceManufacturer);
        addString(hashMap, "device_name", this.deviceInfo.deviceName);
        addString(hashMap, "device_type", this.deviceInfo.deviceType);
        ...
        addLong(hashMap, "event_count", (long) this.activityStateCopy.f36934a);
