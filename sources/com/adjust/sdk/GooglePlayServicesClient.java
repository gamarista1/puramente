...
public class GooglePlayServicesClient {
    ...
    public static final class a implements ServiceConnection {
        ...
        public final LinkedBlockingQueue<IBinder> f36928c = new LinkedBlockingQueue<>(1);
        ...
        public final IBinder a() {
            if (!this.f36927b) {
                this.f36927b = true;
                return this.f36928c.poll(this.f36926a, TimeUnit.MILLISECONDS);
            }
