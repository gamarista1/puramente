...
public class InstallReferrer implements InvocationHandler {
    ...
    public class b implements Runnable {
        ...
        public final /* synthetic */ Object f36930a;

        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ Method f36931b;

        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ Object[] f36932c;
        ...
        public final void run() {
            try {
                Object unused = InstallReferrer.this.invokeI(this.f36930a, this.f36931b, this.f36932c);
            } catch (Throwable th2) {
    ...
    private Object createInstallReferrerClient(Context context2) {
        ...
        try {
            ...
            str = Util.formatString("InstallReferrer not integrated in project (%s) thrown by (%s)", e10.getMessage(), e10.getClass().getCanonicalName());
            installReferrerReadListener.onFail(str);
            return null;
        } catch (Exception e11) {
            installReferrerReadListener = this.referrerCallback;
            str = Util.formatString("createInstallReferrerClient error (%s) from (%s)", e11.getMessage(), e11.getClass().getCanonicalName());
            installReferrerReadListener.onFail(str);
            return null;
        }
    }
    ...
    private Boolean getBooleanGooglePlayInstantParam(Object obj) {
        ...
        try {
            Boolean bool = (Boolean) Reflection.invokeInstanceMethod(obj, "getGooglePlayInstantParam", (Class[]) null, new Object[0]);
            bool.booleanValue();
            return bool;
    ...
    private void startConnection(Class cls, Object obj) {
        ...
        try {
            ...
            if (Util.hasRootCause(e10)) {
                installReferrerReadListener = this.referrerCallback;
                str = Util.formatString("InstallReferrer encountered an InvocationTargetException %s", Util.getRootCause(e10));
            } else {
            ...
            installReferrerReadListener = this.referrerCallback;
            str = Util.formatString("startConnection error (%s) thrown by (%s)", e11.getMessage(), e11.getClass().getCanonicalName());
        }
        installReferrerReadListener.onFail(str);
    }
}
