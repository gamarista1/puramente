...
public class AdjustInstance {
    ...
    public class a extends AsyncTaskExecutor<Void, Uri> {
        ...
        public final /* synthetic */ OnLastDeeplinkReadListener f36902b;

        public a(Context context, OnLastDeeplinkReadListener onLastDeeplinkReadListener) {
            this.f36901a = context;
            this.f36902b = onLastDeeplinkReadListener;
        }

        public final Object doInBackground(Object[] objArr) {
            Void[] voidArr = (Void[]) objArr;
            try {
                return Uri.parse(AdjustInstance.this.getCachedDeeplink(this.f36901a));
        ...
        public final void onPostExecute(Object obj) {
            this.f36902b.onLastDeeplinkRead((Uri) obj);
        }
    }
    ...
    public class b extends AsyncTaskExecutor<Context, Boolean> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ OnIsEnabledListener f36904a;

        public b(OnIsEnabledListener onIsEnabledListener) {
            this.f36904a = onIsEnabledListener;
        }
        ...
        public final void onPostExecute(Object obj) {
            this.f36904a.onIsEnabledRead(((Boolean) obj).booleanValue());
        }
    }
    ...
    public class c implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addGlobalCallbackParameterI(this.f36905a, this.f36906b);
        }
    }
    ...
    public class d implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addGlobalPartnerParameterI(this.f36907a, this.f36908b);
        }
    }
    ...
    public class e implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.removeGlobalCallbackParameterI(this.f36909a);
        }
    }
    ...
    public class f implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.removeGlobalPartnerParameterI(this.f36910a);
        }
    }
    ...
    public class i extends AsyncTaskExecutor<Void, String> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ OnSdkVersionReadListener f36911a;

        public i(OnSdkVersionReadListener onSdkVersionReadListener) {
            this.f36911a = onSdkVersionReadListener;
        }
        ...
        public final void onPostExecute(Object obj) {
            this.f36911a.onSdkVersionRead((String) obj);
        }
    }
    ...
    public class j implements InstallReferrerReadListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ OnGooglePlayInstallReferrerReadListener f36912a;

        public j(OnGooglePlayInstallReferrerReadListener onGooglePlayInstallReferrerReadListener) {
            this.f36912a = onGooglePlayInstallReferrerReadListener;
        }

        public final void onFail(String str) {
            this.f36912a.onFail(str);
        }

        public final void onInstallReferrerRead(ReferrerDetails referrerDetails, String str) {
            this.f36912a.onInstallReferrerRead(new GooglePlayInstallReferrerDetails(referrerDetails));
        }
    }
