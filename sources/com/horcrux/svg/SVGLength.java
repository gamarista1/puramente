...
class SVGLength {
    ...
    final double f58808a;

    /* renamed from: b  reason: collision with root package name */
    final UnitType f58809b;
    ...
    static /* synthetic */ class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f58810a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58810a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58810a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.SVGLength.a.<clinit>():void");
        }
    }

    private SVGLength() {
        this.f58808a = 0.0d;
        this.f58809b = UnitType.UNKNOWN;
    }

    static ArrayList a(Dynamic dynamic) {
        int i10 = a.f58810a[dynamic.getType().ordinal()];
        if (i10 != 1) {
            int i11 = 0;
            if (i10 == 2) {
                String[] split = dynamic.asString().trim().replaceAll(f.f37529a, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).split(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
                ArrayList arrayList = new ArrayList(split.length);
                int length = split.length;
                while (i11 < length) {
                    arrayList.add(new SVGLength(split[i11]));
                    i11++;
                }
                return arrayList;
            } else if (i10 != 3) {
