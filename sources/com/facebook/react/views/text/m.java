...
public final class m {
    ...
    public static final m f42181a = new m();
    ...
    public static final Typeface a(Typeface typeface, int i10, int i11, String str, AssetManager assetManager) {
        ...
        if (str != null) {
            return a.f30562c.c().f(str, cVar, assetManager);
        }
        if (typeface == null) {
    ...
    public static final int b(String str) {
        if (C6496s.c(str, "italic")) {
            return 2;
        }
        if (C6496s.c(str, Constants.NORMAL)) {
            return 0;
        }
        return -1;
    }
    ...
    public static final int d(java.lang.String r1) {
        ...
        L_0x008f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.text.m.d(java.lang.String):int");
    }
}
