...
class TurboModuleInteropUtils {
    ...
    static class MethodDescriptor {
        ...
        MethodDescriptor(String str, String str2, String str3, int i10) {
            this.methodName = str;
    ...
    private static String createJSIReturnKind(String str, String str2, Class<?>[] clsArr, Class<?> cls) {
        ...
        while (i10 < clsArr.length) {
            if (clsArr[i10] != Promise.class) {
                i10++;
            } else if (i10 == clsArr.length - 1) {
                return "PromiseKind";
            } else {
    ...
    private static String createJniSignature(String str, String str2, Class<?>[] clsArr, Class<?> cls) {
        ...
        for (Class<?> convertParamClassToJniType : clsArr) {
            sb2.append(convertParamClassToJniType(str, str2, convertParamClassToJniType));
        }
        sb2.append(")");
