...
public class ColorPropConverter {
    ...
    public static Integer getColor(Object obj, Context context) {
        ...
        try {
            ...
            a.L("ReactNative", e10, "Error extracting color from WideGamut", new Object[0]);
        }
    ...
    private static int resolveResource(Context context, String str) {
        ...
        return h.d(context.getResources(), context.getResources().getIdentifier(split2[1], str2, packageName), context.getTheme());
    }
    ...
    public static Integer getColor(Object obj, Context context, int i10) {
        try {
            ...
            a.L("ReactNative", e10, "Error converting ColorValue", new Object[0]);
