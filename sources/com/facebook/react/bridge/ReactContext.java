...
public abstract class ReactContext extends ContextWrapper {
    ...
    public void assertOnJSQueueThread() {
        ((MessageQueueThread) C3863a.c(this.mJSMessageQueueThread)).assertIsOnThread();
    }

    public void assertOnNativeModulesQueueThread() {
        if (this.mIsInitialized) {
            ((MessageQueueThread) C3863a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread();
            return;
        }
    ...
    public void assertOnUiQueueThread() {
        ((MessageQueueThread) C3863a.c(this.mUiMessageQueueThread)).assertIsOnThread();
    }
    ...
    @Deprecated(since = "This method will be deprecated later as part of Stable APIs with bridge removal and not encouraged usage.")
    ...
    public synchronized void initializeMessageQueueThreads(ReactQueueConfiguration reactQueueConfiguration) {
        U5.a.b(TAG, "initializeMessageQueueThreads() is called.");
    ...
    public boolean isOnJSQueueThread() {
        return ((MessageQueueThread) C3863a.c(this.mJSMessageQueueThread)).isOnThread();
    }

    public boolean isOnNativeModulesQueueThread() {
        return ((MessageQueueThread) C3863a.c(this.mNativeModulesMessageQueueThread)).isOnThread();
    }

    public boolean isOnUiQueueThread() {
        return ((MessageQueueThread) C3863a.c(this.mUiMessageQueueThread)).isOnThread();
    }
    ...
    public boolean runOnJSQueueThread(Runnable runnable) {
        return ((MessageQueueThread) C3863a.c(this.mJSMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnNativeModulesQueueThread(Runnable runnable) {
        ((MessageQueueThread) C3863a.c(this.mNativeModulesMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnUiQueueThread(Runnable runnable) {
        ((MessageQueueThread) C3863a.c(this.mUiMessageQueueThread)).runOnQueue(runnable);
    }
    ...
    public void assertOnNativeModulesQueueThread(String str) {
        if (this.mIsInitialized) {
            ((MessageQueueThread) C3863a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread(str);
            return;
        }
