...
final class CoroutinesExtensionsKt$awaitCustomerInfo$2$2 extends C6498u implements C6798l {
    final /* synthetic */ C6658d<CustomerInfo> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitCustomerInfo$2$2(C6658d<? super CustomerInfo> dVar) {
        super(1);
