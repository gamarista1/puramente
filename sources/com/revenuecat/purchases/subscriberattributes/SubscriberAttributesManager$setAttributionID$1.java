...
final class SubscriberAttributesManager$setAttributionID$1 extends C6498u implements C6798l {
    ...
    public final void invoke(Map<String, String> map) {
        ...
        this.this$0.setAttributes(O.p(O.f(C6502A.a(this.$attributionKey.getBackendKey(), this.$value)), map), this.$appUserID);
    }
}
