...
final class EventsManager$Companion$backendEvents$1 extends C6498u implements C6798l {
    ...
    public final String invoke(BackendStoredEvent backendStoredEvent) {
        C6496s.h(backendStoredEvent, "event");
        return EventsManager.json.c(BackendStoredEvent.Companion.serializer(), backendStoredEvent);
    }
}
