...
final class CoroutinesExtensionsKt$awaitLogOut$2$1 extends C6498u implements C6798l {
    final /* synthetic */ C6658d<CustomerInfo> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitLogOut$2$1(C6658d<? super CustomerInfo> dVar) {
        super(1);
