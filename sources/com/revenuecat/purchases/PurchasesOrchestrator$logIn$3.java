...
final class PurchasesOrchestrator$logIn$3 extends C6498u implements C6798l {
    final /* synthetic */ LogInCallback $callback;
    final /* synthetic */ PurchasesOrchestrator this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PurchasesOrchestrator$logIn$3(PurchasesOrchestrator purchasesOrchestrator, LogInCallback logInCallback) {
        super(1);
        ...
        purchasesOrchestrator.dispatch(new C6787a() {
            public final void invoke() {
                ...
                if (logInCallback != null) {
                    logInCallback.onReceived(customerInfo, false);
                }
            }
        });
    }
