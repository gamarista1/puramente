...
final class PurchasesOrchestrator$getCustomerCenterConfig$2 extends C6498u implements C6798l {
    final /* synthetic */ GetCustomerCenterConfigCallback $callback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PurchasesOrchestrator$getCustomerCenterConfig$2(GetCustomerCenterConfigCallback getCustomerCenterConfigCallback) {
        super(1);
