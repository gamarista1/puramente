...
final class PurchasesOrchestrator$getAmazonLWAConsentStatus$2 extends C6498u implements C6798l {
    final /* synthetic */ GetAmazonLWAConsentStatusCallback $callback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PurchasesOrchestrator$getAmazonLWAConsentStatus$2(GetAmazonLWAConsentStatusCallback getAmazonLWAConsentStatusCallback) {
        super(1);
