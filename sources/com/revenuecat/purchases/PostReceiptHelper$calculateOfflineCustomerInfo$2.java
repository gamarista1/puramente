...
final class PostReceiptHelper$calculateOfflineCustomerInfo$2 extends C6498u implements C6798l {
    final /* synthetic */ C6798l $onError;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostReceiptHelper$calculateOfflineCustomerInfo$2(C6798l lVar) {
        super(1);
        this.$onError = lVar;
    }
