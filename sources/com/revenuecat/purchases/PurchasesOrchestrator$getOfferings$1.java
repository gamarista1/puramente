...
final class PurchasesOrchestrator$getOfferings$1 extends C6498u implements C6798l {
    final /* synthetic */ ReceiveOfferingsCallback $listener;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PurchasesOrchestrator$getOfferings$1(ReceiveOfferingsCallback receiveOfferingsCallback) {
        super(1);
