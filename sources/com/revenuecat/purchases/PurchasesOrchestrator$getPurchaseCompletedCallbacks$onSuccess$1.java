...
final class PurchasesOrchestrator$getPurchaseCompletedCallbacks$onSuccess$1 extends C6498u implements p {
    ...
    public final void invoke(StoreTransaction storeTransaction, CustomerInfo customerInfo) {
        ...
        if (access$getPurchaseCallback != null) {
            this.this$0.dispatch(new PurchasesOrchestrator$getPurchaseCompletedCallbacks$onSuccess$1$1$1(access$getPurchaseCallback, storeTransaction, customerInfo));
        }
    }
}
