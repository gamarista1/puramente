...
final class zzki implements zzkr {
            ...
            if (zzd2 != 11) {
                ...
                while (true) {
                    try {
                        ...
                        if (zzd4 == 16) {
                            i10 = zzkq.zzj();
                            obj2 = zzif.zzd(zzie, this.zza, i10);
                        } else if (zzd4 == 26) {
                            if (obj2 != null) {
    ...
    public final void zzi(Object obj, byte[] bArr, int i10, int i11, zzgj zzgj) {
        ...
        Object obj2 = null;
        while (i10 < i11) {
            int zzi = zzgk.zzi(bArr, i10, zzgj);
            int i12 = zzgj.zza;
            if (i12 == 11) {
                int i13 = 0;
                zzgw zzgw = null;
                while (zzi < i11) {
                    ...
                    if (i15 != 2) {
                        ...
                        zzi = zzgk.zzi(bArr, zzi, zzgj);
                        i13 = zzgj.zza;
                        obj2 = this.zzd.zzd(zzgj.zzd, this.zza, i13);
                    }
                    if (i14 == 12) {
                        break;
                    }
                    zzi = zzgk.zzo(i14, bArr, zzi, i11, zzgj);
                }
                if (zzgw != null) {
                    zzlm.zzj((i13 << 3) | 2, zzgw);
                }
                i10 = zzi;
            } else if ((i12 & 7) == 2) {
                obj2 = this.zzd.zzd(zzgj.zzd, this.zza, i12 >>> 3);
                if (obj2 == null) {
                    i10 = zzgk.zzh(i12, bArr, zzi, i11, zzlm, zzgj);
                } else {
                    int i18 = zzkn.zza;
                    throw null;
                }
            } else {
                i10 = zzgk.zzo(i12, bArr, zzi, i11, zzgj);
            }
        }
        if (i10 != i11) {
            throw zzje.zzg();
