...
class zzle extends AbstractMap {
    ...
    /* synthetic */ zzle(int i10, zzld zzld) {
        this.zza = i10;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i11 = 0;
        if (i10 >= 0) {
            int compareTo = comparable.compareTo(((zzky) this.zzb.get(i10)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i10 = 0; i10 < zzb2; i10++) {
            if (!zzg(i10).equals(zzle.zzg(i10))) {
                return false;
            }
        }
        if (zzb2 != size) {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < zzb2; i11++) {
            i10 += ((zzky) this.zzb.get(i11)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzky zzky = (zzky) this.zzb.remove(i11 - 1);
