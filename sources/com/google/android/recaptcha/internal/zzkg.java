...
final class zzkg {
    ...
    private static void zzd(zzke zzke, StringBuilder sb2, int i10) {
        int i11;
        boolean z10;
        Method method;
        Method method2;
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                zzb(sb3, i12, substring.substring(0, substring.length() - 4), zzit.zzz(method2, zzke2, new Object[0]));
            } else if (substring.endsWith("Map") && !substring.equals("Map") && (method = (Method) entry.getValue()) != null && method.getReturnType().equals(Map.class) && !method.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method.getModifiers())) {
                zzb(sb3, i12, substring.substring(0, substring.length() - 3), zzit.zzz(method, zzke2, new Object[0]));
        ...
        if (zzke2 instanceof zzip) {
            ...
            while (zzf.hasNext()) {
                ...
                zzb(sb3, i12, "[" + ((zziq) entry2.getKey()).zza + "]", entry2.getValue());
            }
        }
