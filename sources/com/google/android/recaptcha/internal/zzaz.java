...
public final class zzaz extends SQLiteOpenHelper {
    ...
    public final int zza(List list) {
        ...
        return getWritableDatabase().delete("ce", "id IN ".concat(String.valueOf(C6565s.x0(list, ", ", "(", ")", 0, (CharSequence) null, zzay.zza, 24, (Object) null))), (String[]) null);
    }
    ...
    public final java.util.List zzd() {
        ...
        L_0x0016:
            ...
            kotlin.jvm.internal.C6496s.e(r3)     // Catch:{ Exception -> 0x0048 }
        ...
        L_0x0046:
            ...
            goto L_0x0050
        L_0x0048:
            java.util.List r1 = mf.C6565s.n()     // Catch:{ all -> 0x0046 }
        L_0x004c:
            r0.close()
            return r1
        L_0x0050:
