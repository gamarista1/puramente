...
import com.google.firebase.auth.C4814u;
...
public final class zzach {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0051, code lost:
        return new com.google.firebase.auth.C4819z(zza(r0), r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x00c5, code lost:
        return new ub.C5227d(r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00db, code lost:
        return new com.google.firebase.auth.C4817x(zza(r0), r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x00e5, code lost:
        return new com.google.firebase.auth.C4807q(zza(r0), r1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static ub.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            int r0 = r3.p0()
        ...
        L_0x0048:
            ...
            return r3
        L_0x0052:
            com.google.firebase.auth.h0 r3 = new com.google.firebase.auth.h0
            java.lang.String r0 = zza((int) r0)
            r3.<init>(r0, r1)
            return r3
        L_0x005c:
        ...
        L_0x00aa:
            ...
            return r0
        L_0x00b6:
            com.google.firebase.auth.g0 r3 = new com.google.firebase.auth.g0
            java.lang.String r0 = zza((int) r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00c0:
        ...
        L_0x0100:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzach.zza(com.google.android.gms.common.api.Status):ub.m");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C4807q) {
            return ((C4807q) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C4807q) {
            return ((C4807q) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static m zza(Status status, C4789h hVar, String str, String str2) {
        int p02 = status.p0();
        if (p02 != 17012 && p02 != 17007 && p02 != 17025) {
            return zza(status);
        }
        return new C4817x(zza(p02), zza(zzb(p02), status)).c(hVar).d(str).e(str2);
    }

    public static C4814u zza(FirebaseAuth firebaseAuth, zzym zzym, A a10) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzym);
        Pair pair = zza.get(17078);
        return new C4814u((String) pair.first, (String) pair.second, C4264l.s0(zzym, firebaseAuth, a10));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.q0())) {
            return str;
        }
        return String.format(str + " [ %s ]", new Object[]{status.q0()});
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C4807q) {
            return ((C4807q) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
