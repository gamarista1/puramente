...
public final class zzadq {
    ...
    public final void zza() {
        ...
        intent.putExtra("com.google.firebase.auth.KEY_API_KEY", this.zza.j().r().b());
        if (!TextUtils.isEmpty(this.zza.p())) {
            intent.putExtra("com.google.firebase.auth.KEY_TENANT_ID", this.zza.p());
        }
        intent.putExtra("com.google.firebase.auth.internal.CLIENT_VERSION", zzact.zza().zzb());
        intent.putExtra("com.google.firebase.auth.internal.FIREBASE_APP_NAME", this.zza.j().q());
        intent.putExtra("com.google.firebase.auth.KEY_CUSTOM_AUTH_DOMAIN", this.zza.l());
