...
final class zzke extends zzhu<Long> implements zzjq, zzlf, RandomAccess {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzjm.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    /* renamed from: zzc */
    public final zzjq zza(int i10) {
        if (i10 >= this.zzc) {
            return new zzke(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzke(long[] jArr, int i10, boolean z10) {
        super(z10);
        this.zzb = jArr;
        this.zzc = i10;
    }
