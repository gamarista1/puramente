...
public final class zznb implements zznc {
    ...
    static {
        ...
        zzf = zza2.zza("measurement.config.url_scheme", Constants.SCHEME);
        zzg = zza2.zza("measurement.upload.debug_upload_interval", 1000);
        zzh = zza2.zza("measurement.session.engagement_interval", 3600000);
        ...
        zzk = zza2.zza("measurement.lifetimevalue.max_currency_tracked", 4);
        zzl = zza2.zza("measurement.dma_consent.max_daily_dcu_realtime_events", 1);
        zzm = zza2.zza("measurement.upload.max_event_parameter_value_length", 100);
        zzn = zza2.zza("measurement.store.max_stored_events_per_app", 100000);
        zzo = zza2.zza("measurement.experiment.max_ids", 50);
        zzp = zza2.zza("measurement.audience.filter_result_max_count", 200);
        zzq = zza2.zza("measurement.upload.max_item_scoped_custom_parameters", 27);
        zzr = zza2.zza("measurement.rb.attribution.client.min_ad_services_version", 7);
        zzs = zza2.zza("measurement.alarm_manager.minimum_interval", 60000);
        zzt = zza2.zza("measurement.upload.minimum_delay", 500);
        zzu = zza2.zza("measurement.monitoring.sample_period_millis", 86400000);
        ...
        zzw = zza2.zza("measurement.upload.realtime_upload_interval", 10000);
        zzx = zza2.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000);
        zza2.zza("measurement.config.cache_time.service", 3600000);
        zzy = zza2.zza("measurement.service_client.idle_disconnect_millis", 5000);
        ...
        zzaa = zza2.zza("measurement.upload.stale_data_deletion_interval", 86400000);
        zzab = zza2.zza("measurement.rb.attribution.uri_authority", "google-analytics.com");
        zzac = zza2.zza("measurement.rb.attribution.max_queue_time", 1209600000);
        ...
        zzaf = zza2.zza("measurement.rb.attribution.uri_scheme", Constants.SCHEME);
        zzag = zza2.zza("measurement.sdk.attribution.cache.ttl", 604800000);
        zzah = zza2.zza("measurement.redaction.app_instance_id.ttl", 7200000);
        zzai = zza2.zza("measurement.upload.backoff_period", 43200000);
        zzaj = zza2.zza("measurement.upload.initial_upload_delay_time", 15000);
        zzak = zza2.zza("measurement.upload.interval", 3600000);
        zzal = zza2.zza("measurement.upload.max_bundle_size", 65536);
        zzam = zza2.zza("measurement.upload.max_bundles", 100);
        zzan = zza2.zza("measurement.upload.max_conversions_per_day", 500);
        zzao = zza2.zza("measurement.upload.max_error_events_per_day", 1000);
        zzap = zza2.zza("measurement.upload.max_events_per_bundle", 1000);
        zzaq = zza2.zza("measurement.upload.max_events_per_day", 100000);
        zzar = zza2.zza("measurement.upload.max_public_events_per_day", 50000);
        zzas = zza2.zza("measurement.upload.max_queue_time", 2419200000L);
        zzat = zza2.zza("measurement.upload.max_realtime_events_per_day", 10);
        zzau = zza2.zza("measurement.upload.max_batch_size", 65536);
        zzav = zza2.zza("measurement.upload.retry_count", 6);
        zzaw = zza2.zza("measurement.upload.retry_time", 1800000);
        zzax = zza2.zza("measurement.upload.url", "https://app-measurement.com/a");
        zzay = zza2.zza("measurement.upload.window_interval", 3600000);
