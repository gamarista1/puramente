...
public final class zzab extends C5194b {
    public zzab(Activity activity) {
        super(activity);
    }

    public final Task<Void> startSmsRetriever() {
        return doWrite(C4510w.a().b(new zzx(this)).d(zzac.zzc).e(1567).a());
    }

    public final Task<Void> startSmsUserConsent(String str) {
        return doWrite(C4510w.a().b(new zzy(this, str)).d(zzac.zzd).e(1568).a());
    }
