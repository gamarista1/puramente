...
public final class zzbg extends zzbh implements NavigableMap {
    ...
    zzbg(zzbu zzbu, zzaz zzaz, zzbg zzbg) {
        this.zze = zzbu;
        this.zzf = zzaz;
        this.zzg = zzbg;
    }
    ...
    private final zzbg zzl(int i10, int i11) {
        ...
        return new zzbg(this.zze.zzu(i10, i11), this.zzf.subList(i10, i11), (zzbg) null);
    }
    ...
    public final zzbg tailMap(Object obj, boolean z10) {
        zzbu zzbu = this.zze;
        obj.getClass();
        return zzl(zzbu.zzt(obj, z10), this.zzf.size());
    }
}
