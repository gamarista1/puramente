...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0006\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00050\u0004H\u0016¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/google/firebase/FirebaseCommonKtxRegistrar;", "Lcom/google/firebase/components/ComponentRegistrar;", "<init>", "()V", "", "LEb/c;", "getComponents", "()Ljava/util/List;", "com.google.firebase-firebase-common"}, k = 1, mv = {1, 8, 0}, xi = 48)
@Keep
public final class FirebaseCommonKtxRegistrar implements ComponentRegistrar {
    ...
    public static final class c implements g {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final c f56838a = new c();
    ...
    public List<C4282c> getComponents() {
        ...
        C4282c d10 = C4282c.c(E.a(cls, cls2)).b(q.k(E.a(cls, cls3))).f(a.f56836a).d();
        C6496s.g(d10, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        Class<yb.c> cls4 = yb.c.class;
        C4282c d11 = C4282c.c(E.a(cls4, cls2)).b(q.k(E.a(cls4, cls3))).f(b.f56837a).d();
        C6496s.g(d11, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        Class<yb.b> cls5 = yb.b.class;
        C4282c d12 = C4282c.c(E.a(cls5, cls2)).b(q.k(E.a(cls5, cls3))).f(c.f56838a).d();
        C6496s.g(d12, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        Class<yb.d> cls6 = yb.d.class;
        C4282c d13 = C4282c.c(E.a(cls6, cls2)).b(q.k(E.a(cls6, cls3))).f(d.f56839a).d();
