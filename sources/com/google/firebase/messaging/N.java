...
public class N {
    ...
    private final Bundle f57432a;

    public N(Bundle bundle) {
        if (bundle != null) {
            this.f57432a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f57432a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f57432a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f57432a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f57432a);
        for (String next : this.f57432a.keySet()) {
            if (!s(next)) {
                bundle.remove(next);
            }
        }
