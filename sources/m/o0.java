...
public abstract class o0 {
    ...
    public static final CursorAnchorInfo b(CursorAnchorInfo.Builder builder, Q q10, I i10, L l10, Matrix matrix, C2423i iVar, C2423i iVar2, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        int l12 = Q0.Q.l(q10.g());
        builder.setSelectionRange(l12, Q0.Q.k(q10.g()));
        I i13 = i10;
        if (z10) {
        ...
        if (i14 >= 33 && z12) {
            C2423i iVar4 = iVar2;
            C1271l.a(builder, iVar2);
        }
        if (i14 >= 34 && z13) {
            C1273n.a(builder, l10, iVar);
        }
        return builder.build();
    }

    public static final boolean c(C2423i iVar, float f10, float f11) {
        float i10 = iVar.i();
